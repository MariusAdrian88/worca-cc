...
`,a)}paste(l){this._core.paste(l)}refresh(l,a){this._verifyIntegers(l,a),this._core.refresh(l,a)}reset(){this._core.reset()}clearTextureAtlas(){this._core.clearTextureAtlas()}loadAddon(l){this._addonManager.loadAddon(this,l)}static get strings(){return i}_verifyIntegers(...l){for(let a of l)if(a===1/0||isNaN(a)||a%1!=0)throw new Error("This API only accepts integers")}_verifyPositiveIntegers(...l){for(let a of l)if(a&&(a===1/0||isNaN(a)||a%1!=0||a<0))throw new Error("This API only accepts positive integers")}}u.Terminal=b})(),n})()))});var Qo={};So(Qo,{FitAddon:()=>rc});var ic,sc,rc,en=wo(()=>{ic=2,sc=1,rc=class{activate(e){this._terminal=e}dispose(){}fit(){let e=this.proposeDimensions();if(!e||!this._terminal||isNaN(e.cols)||isNaN(e.rows))return;let t=this._terminal._core;(this._terminal.rows!==e.rows||this._terminal.cols!==e.cols)&&(t._renderService.clear(),this._terminal.resize(e.cols,e.rows))}proposeDimensions(){if(!this._terminal||!this._terminal.element||!this._terminal.element.parentElement)return;let e=this._terminal._core._renderService.dimensions;if(e.css.cell.width===0||e.css.cell.height===0)return;let t=this._terminal.options.scrollback===0?0:this._terminal.options.overviewRuler?.width||14,s=window.getComputedStyle(this._terminal.element.parentElement),n=parseInt(s.getPropertyValue("height")),u=Math.max(0,parseInt(s.getPropertyValue("width"))),i=window.getComputedStyle(this._terminal.element),o={top:parseInt(i.getPropertyValue("padding-top")),bottom:parseInt(i.getPropertyValue("padding-bottom")),right:parseInt(i.getPropertyValue("padding-right")),left:parseInt(i.getPropertyValue("padding-left"))},c=o.top+o.bottom,p=o.right+o.left,d=n-c,f=u-p-t;return{cols:Math.max(ic,Math.floor(f/e.css.cell.width)),rows:Math.max(sc,Math.floor(d/e.css.cell.height))}}}});var En={};So(En,{SearchAddon:()=>eh});function kr(e){ac(e)||nc.onUnexpectedError(e)}function ac(e){return e instanceof lc?!0:e instanceof Error&&e.name===Lr&&e.message===Lr}function cc(e,t,s=0,n=e.length){let u=s,i=n;for(;u<i;){let o=Math.floor((u+i)/2);t(e[o])?u=o+1:i=o}return u-1}function dc(e,t){return(s,n)=>t(e(s),e(n))}function pc(e,t){let s=Object.create(null);for(let n of e){let u=t(n),i=s[u];i||(i=s[u]=[]),i.push(n)}return s}function _c(e,t){let s=this,n=!1,u;return function(){if(n)return u;if(n=!0,t)try{u=e.apply(s,arguments)}finally{t()}else u=e.apply(s,arguments);return u}}function vc(e){ii=e}function Cs(e){return ii?.trackDisposable(e),e}function xs(e){ii?.markAsDisposed(e)}function Bi(e,t){ii?.setParent(e,t)}function bc(e,t){if(ii)for(let s of e)ii.setParent(s,t)}function Mi(e){if(pn.is(e)){let t=[];for(let s of e)if(s)try{s.dispose()}catch(n){t.push(n)}if(t.length===1)throw t[0];if(t.length>1)throw new AggregateError(t,"Encountered errors while disposing of store");return Array.isArray(e)?[]:e}else if(e)return e.dispose(),e}function _n(...e){let t=si(()=>Mi(e));return bc(e,t),t}function si(e){let t=Cs({dispose:_c(()=>{xs(t),e()})});return t}function kn(e,t=0,s){let n=setTimeout(()=>{e(),s&&u.dispose()},t),u=si(()=>{clearTimeout(n),s?.deleteAndLeak(u)});return s?.add(u),u}var oc,nc,Lr,lc,tn,hc,un,uc,sn,rn,on,gf,fc,pn,mc,ii,gc,mn,Ir,tt,Ss,nn,yc,wc,Sc,an,Cc,Hr,Or,xc,ln,bn,kc,Br,Ec,Ac,Lc,vs,Dc,Tc,bs,et,Rc,Sn,Oc,Mc,ti,$r,Pr,ys,Bc,$c,Cn,Pc,Ic,Hc,Fc,gs,ws,cn,zc,lt,ct,Ie,xn,Nc,Er,Wc,vf,it,yt,Uc,jc,Vc,qc,bf,yf,wf,Sf,Kc,Ar,Gc,hn,Xc,Yc,Jc,Zc,Qc,eh,An=wo(()=>{oc=class{constructor(){this.listeners=[],this.unexpectedErrorHandler=function(e){setTimeout(()=>{throw e.stack?tn.isErrorNoTelemetry(e)?new tn(e.message+`

`+e.stack):new Error(e.message+`

`+e.stack):e},0)}}addListener(e){return this.listeners.push(e),()=>{this._removeListener(e)}}emit(e){this.listeners.forEach(t=>{t(e)})}_removeListener(e){this.listeners.splice(this.listeners.indexOf(e),1)}setUnexpectedErrorHandler(e){this.unexpectedErrorHandler=e}getUnexpectedErrorHandler(){return this.unexpectedErrorHandler}onUnexpectedError(e){this.unexpectedErrorHandler(e),this.emit(e)}onUnexpectedExternalError(e){this.unexpectedErrorHandler(e)}},nc=new oc;Lr="Canceled";lc=class extends Error{constructor(){super(Lr),this.name=this.message}},tn=class Dr extends Error{constructor(t){super(t),this.name="CodeExpectedError"}static fromError(t){if(t instanceof Dr)return t;let s=new Dr;return s.message=t.message,s.stack=t.stack,s}static isErrorNoTelemetry(t){return t.name==="CodeExpectedError"}};hc=class dn{constructor(t){this._array=t,this._findLastMonotonousLastIdx=0}findLastMonotonous(t){if(dn.assertInvariants){if(this._prevFindLastPredicate){for(let n of this._array)if(this._prevFindLastPredicate(n)&&!t(n))throw new Error("MonotonousArray: current predicate must be weaker than (or equal to) the previous predicate.")}this._prevFindLastPredicate=t}let s=cc(this._array,t,this._findLastMonotonousLastIdx);return this._findLastMonotonousLastIdx=s+1,s===-1?void 0:this._array[s]}};hc.assertInvariants=!1;(e=>{function t(i){return i<0}e.isLessThan=t;function s(i){return i<=0}e.isLessThanOrEqual=s;function n(i){return i>0}e.isGreaterThan=n;function u(i){return i===0}e.isNeitherLessOrGreaterThan=u,e.greaterThan=1,e.lessThan=-1,e.neitherLessOrGreaterThan=0})(un||(un={}));uc=(e,t)=>e-t,sn=class Tr{constructor(t){this.iterate=t}forEach(t){this.iterate(s=>(t(s),!0))}toArray(){let t=[];return this.iterate(s=>(t.push(s),!0)),t}filter(t){return new Tr(s=>this.iterate(n=>t(n)?s(n):!0))}map(t){return new Tr(s=>this.iterate(n=>s(t(n))))}some(t){let s=!1;return this.iterate(n=>(s=t(n),!s)),s}findFirst(t){let s;return this.iterate(n=>t(n)?(s=n,!1):!0),s}findLast(t){let s;return this.iterate(n=>(t(n)&&(s=n),!0)),s}findLastMaxBy(t){let s,n=!0;return this.iterate(u=>((n||un.isGreaterThan(t(u,s)))&&(n=!1,s=u),!0)),s}};sn.empty=new sn(e=>{});gf=class{constructor(e,t){this.toKey=t,this._map=new Map,this[rn]="SetWithKey";for(let s of e)this.add(s)}get size(){return this._map.size}add(e){let t=this.toKey(e);return this._map.set(t,e),this}delete(e){return this._map.delete(this.toKey(e))}has(e){return this._map.has(this.toKey(e))}*entries(){for(let e of this._map.values())yield[e,e]}keys(){return this.values()}*values(){for(let e of this._map.values())yield e}clear(){this._map.clear()}forEach(e,t){this._map.forEach(s=>e.call(t,s,s,this))}[(on=Symbol.iterator,rn=Symbol.toStringTag,on)](){return this.values()}},fc=class{constructor(){this.map=new Map}add(e,t){let s=this.map.get(e);s||(s=new Set,this.map.set(e,s)),s.add(t)}delete(e,t){let s=this.map.get(e);s&&(s.delete(t),s.size===0&&this.map.delete(e))}forEach(e,t){let s=this.map.get(e);s&&s.forEach(t)}get(e){return this.map.get(e)||new Set}};(e=>{function t(y){return y&&typeof y=="object"&&typeof y[Symbol.iterator]=="function"}e.is=t;let s=Object.freeze([]);function n(){return s}e.empty=n;function*u(y){yield y}e.single=u;function i(y){return t(y)?y:u(y)}e.wrap=i;function o(y){return y||s}e.from=o;function*c(y){for(let x=y.length-1;x>=0;x--)yield y[x]}e.reverse=c;function p(y){return!y||y[Symbol.iterator]().next().done===!0}e.isEmpty=p;function d(y){return y[Symbol.iterator]().next().value}e.first=d;function f(y,x){let m=0;for(let S of y)if(x(S,m++))return!0;return!1}e.some=f;function v(y,x){for(let m of y)if(x(m))return m}e.find=v;function*w(y,x){for(let m of y)x(m)&&(yield m)}e.filter=w;function*b(y,x){let m=0;for(let S of y)yield x(S,m++)}e.map=b;function*r(y,x){let m=0;for(let S of y)yield*x(S,m++)}e.flatMap=r;function*l(...y){for(let x of y)yield*x}e.concat=l;function a(y,x,m){let S=m;for(let L of y)S=x(S,L);return S}e.reduce=a;function*h(y,x,m=y.length){for(x<0&&(x+=y.length),m<0?m+=y.length:m>y.length&&(m=y.length);x<m;x++)yield y[x]}e.slice=h;function _(y,x=Number.POSITIVE_INFINITY){let m=[];if(x===0)return[m,y];let S=y[Symbol.iterator]();for(let L=0;L<x;L++){let O=S.next();if(O.done)return[m,e.empty()];m.push(O.value)}return[m,{[Symbol.iterator](){return S}}]}e.consume=_;async function g(y){let x=[];for await(let m of y)x.push(m);return Promise.resolve(x)}e.asyncToArray=g})(pn||(pn={}));mc=!1,ii=null,gc=class fn{constructor(){this.livingDisposables=new Map}getDisposableData(t){let s=this.livingDisposables.get(t);return s||(s={parent:null,source:null,isSingleton:!1,value:t,idx:fn.idx++},this.livingDisposables.set(t,s)),s}trackDisposable(t){let s=this.getDisposableData(t);s.source||(s.source=new Error().stack)}setParent(t,s){let n=this.getDisposableData(t);n.parent=s}markAsDisposed(t){this.livingDisposables.delete(t)}markAsSingleton(t){this.getDisposableData(t).isSingleton=!0}getRootParent(t,s){let n=s.get(t);if(n)return n;let u=t.parent?this.getRootParent(this.getDisposableData(t.parent),s):t;return s.set(t,u),u}getTrackedDisposables(){let t=new Map;return[...this.livingDisposables.entries()].filter(([,s])=>s.source!==null&&!this.getRootParent(s,t).isSingleton).flatMap(([s])=>s)}computeLeakingDisposables(t=10,s){let n;if(s)n=s;else{let p=new Map,d=[...this.livingDisposables.values()].filter(v=>v.source!==null&&!this.getRootParent(v,p).isSingleton);if(d.length===0)return;let f=new Set(d.map(v=>v.value));if(n=d.filter(v=>!(v.parent&&f.has(v.parent))),n.length===0)throw new Error("There are cyclic diposable chains!")}if(!n)return;function u(p){function d(v,w){for(;v.length>0&&w.some(b=>typeof b=="string"?b===v[0]:v[0].match(b));)v.shift()}let f=p.source.split(`
`).map(v=>v.trim().replace("at ","")).filter(v=>v!=="");return d(f,["Error",/^trackDisposable \(.*\)$/,/^DisposableTracker.trackDisposable \(.*\)$/]),f.reverse()}let i=new fc;for(let p of n){let d=u(p);for(let f=0;f<=d.length;f++)i.add(d.slice(0,f).join(`
`),p)}n.sort(dc(p=>p.idx,uc));let o="",c=0;for(let p of n.slice(0,t)){c++;let d=u(p),f=[];for(let v=0;v<d.length;v++){let w=d[v];w=`(shared with ${i.get(d.slice(0,v+1).join(`
`)).size}/${n.length} leaks) at ${w}`;let b=i.get(d.slice(0,v).join(`
`)),r=pc([...b].map(l=>u(l)[v]),l=>l);delete r[d[v]];for(let[l,a]of Object.entries(r))f.unshift(`    - stacktraces of ${a.length} other leaks continue with ${l}`);f.unshift(w)}o+=`
...
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ao=/'/g,Lo=/"/g,Ro=/^(?:script|style|textarea|title)$/i,sr=e=>(t,...s)=>({_$litType$:e,strings:t,values:s}),F=sr(1),Oo=sr(2),Mo=sr(3),Te=Symbol.for("lit-noChange"),K=Symbol.for("lit-nothing"),Do=new WeakMap,At=Lt.createTreeWalker(Lt,129);function Bo(e,t){if(!ir(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return xo!==void 0?xo.createHTML(t):t}var $o=(e,t)=>{let s=e.length-1,n=[],u,i=t===2?"<svg>":t===3?"<math>":"",o=bi;for(let c=0;c<s;c++){let p=e[c],d,f,v=-1,w=0;for(;w<p.length&&(o.lastIndex=w,f=o.exec(p),f!==null);)w=o.lastIndex,o===bi?f[1]==="!--"?o=ko:f[1]!==void 0?o=Eo:f[2]!==void 0?(Ro.test(f[2])&&(u=RegExp("</"+f[2],"g")),o=Et):f[3]!==void 0&&(o=Et):o===Et?f[0]===">"?(o=u??bi,v=-1):f[1]===void 0?v=-2:(v=o.lastIndex-f[2].length,d=f[1],o=f[3]===void 0?Et:f[3]==='"'?Lo:Ao):o===Lo||o===Ao?o=Et:o===ko||o===Eo?o=bi:(o=Et,u=void 0);let b=o===Et&&e[c+1].startsWith("/>")?" ":"";i+=o===bi?p+Rl:v>=0?(n.push(d),p.slice(0,v)+er+p.slice(v)+at+b):p+at+(v===-2?c:b)}return[Bo(e,i+(e[s]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),n]},Ci=class e{constructor({strings:t,_$litType$:s},n){let u;this.parts=[];let i=0,o=0,c=t.length-1,p=this.parts,[d,f]=$o(t,s);if(this.el=e.createElement(d,n),At.currentNode=this.el.content,s===2||s===3){let v=this.el.content.firstChild;v.replaceWith(...v.childNodes)}for(;(u=At.nextNode())!==null&&p.length<c;){if(u.nodeType===1){if(u.hasAttributes())for(let v of u.getAttributeNames())if(v.endsWith(er)){let w=f[o++],b=u.getAttribute(v).split(at),r=/([.?@])?(.*)/.exec(w);p.push({type:1,index:i,name:r[2],strings:b,ctor:r[1]==="."?os:r[1]==="?"?ns:r[1]==="@"?as:Tt}),u.removeAttribute(v)}else v.startsWith(at)&&(p.push({type:6,index:i}),u.removeAttribute(v));if(Ro.test(u.tagName)){let v=u.textContent.split(at),w=v.length-1;if(w>0){u.textContent=ss?ss.emptyScript:"";for(let b=0;b<w;b++)u.append(v[b],wi()),At.nextNode(),p.push({type:2,index:++i});u.append(v[w],wi())}}}else if(u.nodeType===8)if(u.data===tr)p.push({type:2,index:i});else{let v=-1;for(;(v=u.data.indexOf(at,v+1))!==-1;)p.push({type:7,index:i}),v+=at.length-1}i++}}static createElement(t,s){let n=Lt.createElement("template");return n.innerHTML=t,n}};function Dt(e,t,s=e,n){if(t===Te)return t;let u=n!==void 0?s._$Co?.[n]:s._$Cl,i=Si(t)?void 0:t._$litDirective$;return u?.constructor!==i&&(u?._$AO?.(!1),i===void 0?u=void 0:(u=new i(e),u._$AT(e,s,n)),n!==void 0?(s._$Co??(s._$Co=[]))[n]=u:s._$Cl=u),u!==void 0&&(t=Dt(e,u._$AS(e,t.values),u,n)),t}var rs=class{constructor(t,s){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=s}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){let{el:{content:s},parts:n}=this._$AD,u=(t?.creationScope??Lt).importNode(s,!0);At.currentNode=u;let i=At.nextNode(),o=0,c=0,p=n[0];for(;p!==void 0;){if(o===p.index){let d;p.type===2?d=new Xt(i,i.nextSibling,this,t):p.type===1?d=new p.ctor(i,p.name,p.strings,this,t):p.type===6&&(d=new ls(i,this,t)),this._$AV.push(d),p=n[++c]}o!==p?.index&&(i=At.nextNode(),o++)}return At.currentNode=Lt,u}p(t){let s=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(t,n,s),s+=n.strings.length-2):n._$AI(t[s])),s++}},Xt=class e{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,s,n,u){this.type=2,this._$AH=K,this._$AN=void 0,this._$AA=t,this._$AB=s,this._$AM=n,this.options=u,this._$Cv=u?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode,s=this._$AM;return s!==void 0&&t?.nodeType===11&&(t=s.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,s=this){t=Dt(this,t,s),Si(t)?t===K||t==null||t===""?(this._$AH!==K&&this._$AR(),this._$AH=K):t!==this._$AH&&t!==Te&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):To(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==K&&Si(this._$AH)?this._$AA.nextSibling.data=t:this.T(Lt.createTextNode(t)),this._$AH=t}$(t){let{values:s,_$litType$:n}=t,u=typeof n=="number"?this._$AC(t):(n.el===void 0&&(n.el=Ci.createElement(Bo(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===u)this._$AH.p(s);else{let i=new rs(u,this),o=i.u(this.options);i.p(s),this.T(o),this._$AH=i}}_$AC(t){let s=Do.get(t.strings);return s===void 0&&Do.set(t.strings,s=new Ci(t)),s}k(t){ir(this._$AH)||(this._$AH=[],this._$AR());let s=this._$AH,n,u=0;for(let i of t)u===s.length?s.push(n=new e(this.O(wi()),this.O(wi()),this,this.options)):n=s[u],n._$AI(i),u++;u<s.length&&(this._$AR(n&&n._$AB.nextSibling,u),s.length=u)}_$AR(t=this._$AA.nextSibling,s){for(this._$AP?.(!1,!0,s);t!==this._$AB;){let n=Co(t).nextSibling;Co(t).remove(),t=n}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}},Tt=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,s,n,u,i){this.type=1,this._$AH=K,this._$AN=void 0,this.element=t,this.name=s,this._$AM=u,this.options=i,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=K}_$AI(t,s=this,n,u){let i=this.strings,o=!1;if(i===void 0)t=Dt(this,t,s,0),o=!Si(t)||t!==this._$AH&&t!==Te,o&&(this._$AH=t);else{let c=t,p,d;for(t=i[0],p=0;p<i.length-1;p++)d=Dt(this,c[n+p],s,p),d===Te&&(d=this._$AH[p]),o||(o=!Si(d)||d!==this._$AH[p]),d===K?t=K:t!==K&&(t+=(d??"")+i[p+1]),this._$AH[p]=d}o&&!u&&this.j(t)}j(t){t===K?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}},os=class extends Tt{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===K?void 0:t}},ns=class extends Tt{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==K)}},as=class extends Tt{constructor(t,s,n,u,i){super(t,s,n,u,i),this.type=5}_$AI(t,s=this){if((t=Dt(this,t,s,0)??K)===Te)return;let n=this._$AH,u=t===K&&n!==K||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,i=t!==K&&(n===K||u);u&&this.element.removeEventListener(this.name,this,n),i&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}},ls=class{constructor(t,s,n){this.element=t,this.type=6,this._$AN=void 0,this._$AM=s,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(t){Dt(this,t)}},Po={M:er,P:at,A:tr,C:1,L:$o,R:rs,D:To,V:Dt,I:Xt,H:Tt,N:ns,U:as,B:os,F:ls},Ol=yi.litHtmlPolyfillSupport;Ol?.(Ci,Xt),(yi.litHtmlVersions??(yi.litHtmlVersions=[])).push("3.3.2");var cs=(e,t,s)=>{let n=s?.renderBefore??t,u=n._$litPart$;if(u===void 0){let i=s?.renderBefore??null;n._$litPart$=u=new Xt(t.insertBefore(wi(),i),i,void 0,s??{})}return u._$AI(e),u};function Io(e={}){let t={activeRunId:e.activeRunId??null,runs:e.runs??{},logLines:e.logLines??[],preferences:{theme:e.preferences?.theme??"light",sidebarCollapsed:e.preferences?.sidebarCollapsed??!1}},s=new Set;function n(){for(let u of Array.from(s))try{u(t)}catch{}}return{getState(){return t},setState(u){let i={...t,...u,preferences:{...t.preferences,...u.preferences||{}}};i.activeRunId===t.activeRunId&&i.runs===t.runs&&i.logLines===t.logLines&&i.preferences.theme===t.preferences.theme&&i.preferences.sidebarCollapsed===t.preferences.sidebarCollapsed||(t=i,n())},setRun(u,i){let o={...t.runs,[u]:i};t={...t,runs:o},n()},appendLog(u){let i=[...t.logLines,u];i.length>5e3&&i.splice(0,i.length-5e3),t={...t,logLines:i},n()},clearLog(){t={...t,logLines:[]},n()},subscribe(u){return s.add(u),()=>s.delete(u)}}}var Ho=["subscribe-run","unsubscribe-run","subscribe-log","unsubscribe-log","list-runs","get-agent-prompt","get-preferences","set-preferences","stop-run","run-snapshot","run-update","runs-list","log-line","log-bulk","preferences"];function rr(){let e=Date.now().toString(36),t=Math.random().toString(36).slice(2,8);return`${e}-${t}`}function Fo(e,t,s=rr()){return{id:s,type:e,payload:t}}function zo(e={}){let t={initialMs:e.backoff?.initialMs??1e3,maxMs:e.backoff?.maxMs??3e4,factor:e.backoff?.factor??2,jitterRatio:e.backoff?.jitterRatio??.2},s=()=>e.url&&e.url.length>0?e.url:typeof location<"u"?(location.protocol==="https:"?"wss://":"ws://")+location.host+"/ws":"ws://localhost/ws",n=null,u="closed",i=0,o=null,c=!0,p=new Map,d=[],f=new Map,v=new Set;function w(g){for(let y of Array.from(v))try{y(g)}catch{}}function b(){if(!c||o)return;u="reconnecting",w(u);let g=Math.min(t.maxMs,t.initialMs*Math.pow(t.factor,i)),y=t.jitterRatio*g,x=Math.max(0,Math.round(g+(Math.random()*2-1)*y));o=setTimeout(()=>{o=null,_()},x)}function r(g){try{n?.send(JSON.stringify(g))}catch{}}function l(){for(u="open",w(u),i=0;d.length;){let g=d.shift();g&&r(g)}}function a(g){let y;try{y=JSON.parse(String(g.data))}catch{return}if(!y||typeof y.id!="string"||typeof y.type!="string")return;if(p.has(y.id)){let m=p.get(y.id);p.delete(y.id),y.ok?m?.resolve(y.payload):m?.reject(y.error||new Error("ws error"));return}let x=f.get(y.type);if(x&&x.size>0)for(let m of Array.from(x))try{m(y.payload)}catch{}}function h(){u="closed",w(u);for(let[g,y]of p.entries())y.reject(new Error("ws disconnected")),p.delete(g);i+=1,b()}function _(){if(!c)return;let g=s();try{n=new WebSocket(g),u="connecting",w(u),n.addEventListener("open",l),n.addEventListener("message",a),n.addEventListener("error",()=>{}),n.addEventListener("close",h)}catch{b()}}return _(),{send(g,y){if(!Ho.includes(g))return Promise.reject(new Error(`unknown message type: ${g}`));let x=rr(),m=Fo(g,y,x);return new Promise((S,L)=>{p.set(x,{resolve:S,reject:L,type:g}),n&&n.readyState===n.OPEN?r(m):d.push(m)})},on(g,y){f.has(g)||f.set(g,new Set);let x=f.get(g);return x?.add(y),()=>{x?.delete(y)}},onConnection(g){return v.add(g),()=>{v.delete(g)}},close(){c=!1,o&&(clearTimeout(o),o=null);try{n?.close()}catch{}},getState(){return u}}}function or(e){let t=(e||"").replace(/^#\/?/,""),[s,n]=t.split("?"),u=s||"active",i=new URLSearchParams(n||"");return{section:u,runId:i.get("run")||null}}function Ml(e,t){let s=`#/${e}`;return t?`${s}?run=${t}`:s}function No(e){let t=()=>e(or(location.hash));return window.addEventListener("hashchange",t),()=>window.removeEventListener("hashchange",t)}function gt(e,t){location.hash=Ml(e,t)}function xi(e){document.documentElement.setAttribute("data-theme",e)}var Ke={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Yt=e=>(...t)=>({_$litDirective$:e,values:t}),vt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,s,n){this._$Ct=t,this._$AM=s,this._$Ci=n}_$AS(t,s){return this.update(t,s)}update(t,s){return this.render(...s)}};var ki=class extends vt{constructor(t){if(super(t),this.it=K,t.type!==Ke.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===K||t==null)return this._t=void 0,this.it=t;if(t===Te)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;let s=[t];return s.raw=s,this._t={_$litType$:this.constructor.resultType,strings:s,values:[]}}};ki.directiveName="unsafeHTML",ki.resultType=1;var X=Yt(ki);var Jt=[["circle",{cx:"12",cy:"12",r:"10"}]];var Rt=[["circle",{cx:"12",cy:"12",r:"10"}],["path",{d:"m9 12 2 2 4-4"}]];var Ot=[["circle",{cx:"12",cy:"12",r:"10"}],["line",{x1:"12",x2:"12",y1:"8",y2:"12"}],["line",{x1:"12",x2:"12.01",y1:"16",y2:"16"}]];var bt=[["path",{d:"M12 2v4"}],["path",{d:"m16.2 7.8 2.9-2.9"}],["path",{d:"M18 12h4"}],["path",{d:"m16.2 16.2 2.9 2.9"}],["path",{d:"M12 18v4"}],["path",{d:"m4.9 19.1 2.9-2.9"}],["path",{d:"M2 12h4"}],["path",{d:"m4.9 4.9 2.9 2.9"}]];var Ei=[["path",{d:"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"}],["path",{d:"M21 3v5h-5"}],["path",{d:"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"}],["path",{d:"M8 16H3v5"}]];var nr=[["path",{d:"M12 5v14"}],["path",{d:"m19 12-7 7-7-7"}]];var Mt=[["rect",{x:"14",y:"3",width:"5",height:"18",rx:"1"}],["rect",{x:"5",y:"3",width:"5",height:"18",rx:"1"}]];var ar=[["path",{d:"M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z"}]];var lr=[["circle",{cx:"12",cy:"12",r:"10"}],["path",{d:"M12 6v6l4 2"}]];var cr=[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3"}],["path",{d:"M12 9v4"}],["path",{d:"M12 17h.01"}]];var Ai=[["path",{d:"M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2"}]];var hr=[["rect",{width:"20",height:"5",x:"2",y:"3",rx:"1"}],["path",{d:"M4 8v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8"}],["path",{d:"M10 12h4"}]];var dr=[["path",{d:"m21 21-4.34-4.34"}],["circle",{cx:"11",cy:"11",r:"8"}]];var ur=[["path",{d:"m12 19-7-7 7-7"}],["path",{d:"M19 12H5"}]];var pr=[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2"}]];var fr=[["path",{d:"M5 5a2 2 0 0 1 3.008-1.728l11.997 6.998a2 2 0 0 1 .003 3.458l-12 7A2 2 0 0 1 5 19z"}]];var hs=[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"}],["path",{d:"M16 3.128a4 4 0 0 1 0 7.744"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87"}],["circle",{cx:"9",cy:"7",r:"4"}]];var _r=[["path",{d:"M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"}]];var Li=[["path",{d:"M15 6a9 9 0 0 0-9 9V3"}],["circle",{cx:"18",cy:"6",r:"3"}],["circle",{cx:"6",cy:"18",r:"3"}]];var mr=[["path",{d:"m9 18 6-6-6-6"}]];var Di=[["path",{d:"M15.2 3a2 2 0 0 1 1.4.6l3.8 3.8a2 2 0 0 1 .6 1.4V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2z"}],["path",{d:"M17 21v-7a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v7"}],["path",{d:"M7 3v4a1 1 0 0 0 1 1h7"}]];var Ti=[["path",{d:"M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915"}],["circle",{cx:"12",cy:"12",r:"3"}]];var gr=[["line",{x1:"10",x2:"14",y1:"2",y2:"2"}],["line",{x1:"12",x2:"15",y1:"14",y2:"11"}],["circle",{cx:"12",cy:"14",r:"8"}]];var ds=[["path",{d:"M12 20v2"}],["path",{d:"M12 2v2"}],["path",{d:"M17 20v2"}],["path",{d:"M17 2v2"}],["path",{d:"M2 12h2"}],["path",{d:"M2 17h2"}],["path",{d:"M2 7h2"}],["path",{d:"M20 12h2"}],["path",{d:"M20 17h2"}],["path",{d:"M20 7h2"}],["path",{d:"M7 20v2"}],["path",{d:"M7 2v2"}],["rect",{x:"4",y:"4",width:"16",height:"16",rx:"2"}],["rect",{x:"8",y:"8",width:"8",height:"8",rx:"1"}]];var vr=[["path",{d:"M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"}]];var br=[["path",{d:"M6 22a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8a2.4 2.4 0 0 1 1.704.706l3.588 3.588A2.4 2.4 0 0 1 20 8v12a2 2 0 0 1-2 2z"}],["path",{d:"M14 2v5a1 1 0 0 0 1 1h5"}],["path",{d:"M10 9H8"}],["path",{d:"M16 13H8"}],["path",{d:"M16 17H8"}]];var us=[["rect",{width:"8",height:"4",x:"8",y:"2",rx:"1",ry:"1"}],["path",{d:"M8 4H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2"}],["path",{d:"M16 4h2a2 2 0 0 1 2 2v4"}],["path",{d:"M21 14H11"}],["path",{d:"m15 10-4 4 4 4"}]];function Bl(e){return e.map(([t,s])=>{let n=Object.entries(s).map(([u,i])=>`${u}="${i}"`).join(" ");return`<${t} ${n}/>`}).join("")}function Y(e,t=16,s=""){let n=s?` class="${s}"`:"";return`<svg xmlns="http://www.w3.org/2000/svg" width="${t}" height="${t}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"${n}>${Bl(e)}</svg>`}function Wo(e,t,s,{onNavigate:n}){let{runs:u,preferences:i}=e,o=Object.values(u),c=o.filter(v=>v.active).length,p=o.filter(v=>!v.active).length,d=s==="open"?"connected":s==="reconnecting"?"reconnecting":"disconnected",f=s==="open"?"Connected":s==="reconnecting"?"Reconnecting\u2026":"Disconnected";return F`
  ...
  `}var $l={pending:"status-pending",in_progress:"status-in-progress",completed:"status-completed",error:"status-error",interrupted:"status-interrupted"},Pl={pending:Jt,in_progress:bt,completed:Rt,error:Ot,interrupted:Mt};function Zt(e,t){return e==="in_progress"&&t===!1?"interrupted":e}function ps(e){return $l[e]||"status-unknown"}function Qe(e,t=14){let s=Pl[e];return s?Y(s,t,e==="in_progress"?"icon-spin":""):"?"}var Il={pending:Jt,in_progress:bt,completed:Rt,error:Ot,interrupted:Mt};function Hl(e,t){return t&&t[e]?.label?t[e].label:e.replace(/_/g," ").toUpperCase()}function Uo(e,t={},s=!0){if(!e||typeof e!="object")return F``;let n=Object.entries(e);return n.length===0?F`<div class="empty-state">No stages</div>`:F`
    <div class="stage-timeline">
      ${n.map(([u,i],o)=>{let c=Zt(i.status||"pending",s),p=Il[c]||Jt,d=Hl(u,t),f=c==="in_progress",v=i.iteration,w=c==="in_progress"?"icon-spin":"";return F`
  ...
  `}function Qt(e){let t=Math.floor(e/1e3),s=Math.floor(t/3600),n=Math.floor(t%3600/60),u=t%60;return s>0?`${s}h ${n}m ${u}s`:n>0?`${n}m ${u}s`:`${u}s`}function ei(e,t){let s=new Date(e).getTime();return(t?new Date(t).getTime():Date.now())-s}function Bt(e){if(!e)return"N/A";let t=new Date(e),s=n=>String(n).padStart(2,"0");return`${t.getFullYear()}.${s(t.getMonth()+1)}.${s(t.getDate())} ${s(t.getHours())}:${s(t.getMinutes())}`}function Fl(e){if(!e)return null;let t=null;for(let s of Object.values(e))s.completed_at&&(!t||s.completed_at>t)&&(t=s.completed_at);return t}function zl(e){return e==="completed"?"success":e==="error"?"danger":e==="in_progress"||e==="interrupted"?"warning":"neutral"}function Nl(e){let t=e.status||"pending";return t==="completed"&&e.outcome==="success"?F`<span class="iter-status-icon success">${X(Qe("completed",12))}</span>`:t==="completed"?F`<span class="iter-status-icon">${X(Qe("completed",12))}</span>`:t==="error"?F`<span class="iter-status-icon failure">${X(Qe("error",12))}</span>`:t==="in_progress"?F`<span class="iter-status-icon in-progress">${X(Qe("in_progress",12))}</span>`:K}function Vo(e){return e?F`<span class="iteration-trigger">${{initial:"Initial run",test_failure:"Test failure",review_changes:"Review changes",restart_planning:"Restart planning"}[e]||e}</span>`:K}function qo(e){return e?F`<span class="iteration-outcome ${e==="success"?"success":"failure"}">${e.replace(/_/g," ")}</span>`:K}function yr(e,t,s=K){let n=e?Qt(ei(e,t||null)):"";return F`
  ...
  `}function Wl(e,t,s){let n=e.agent||s||t,u=e.model||"";return F`
    <div class="iteration-detail">
      ${yr(e.started_at,e.completed_at)}
      ...
      ${e.trigger?F`<div class="detail-row">${Vo(e.trigger)}</div>`:K}
      ${e.outcome?F`<div class="detail-row">${qo(e.outcome)}</div>`:K}
    </div>
  `}function jo(e,t){navigator.clipboard.writeText(e).then(()=>{t.textContent="Copied!",setTimeout(()=>{t.textContent="Copy"},1500)})}function Ul(e,t){if(!t)return K;let{agentInstructions:s,userPrompt:n}=t;return!s&&!n?K:F`
      ...
      ${n?F`
        <div class="agent-prompt-block">
          <div class="agent-prompt-label-row">
            ...
            <button class="copy-btn" @click=${u=>jo(n,u.currentTarget)}>
              ${X(Y(us,11))} Copy
            </button>
          </div>
      ...
      ${s?F`
        <div class="agent-prompt-block">
          <div class="agent-prompt-label-row">
            ...
            <button class="copy-btn" @click=${u=>jo(s,u.currentTarget)}>
              ${X(Y(us,11))} Copy
            </button>
          </div>
  ...
  `}function Ko(e,t={},s={}){if(!e)return F`<div class="empty-state">Select a run to view details</div>`;let n=e.branch||e.work_request?.branch||"",u=e.pr_url||null,i=e.completed_at||(e.active?null:Fl(e.stages)),o=e.stages||{},c=t.stageUi||{},p=t.agents||{};return F`
            ...
            <sl-details ?open=${w==="in_progress"} class="stage-panel">
              ...
              `:F`
                <div class="stage-detail">
                  ${yr(f.started_at,f.completed_at)}
                  <div class="stage-info-strip">
                  ...
                  ${a.length===1&&a[0].trigger?F`<div class="detail-row">${Vo(a[0].trigger)}</div>`:K}
                  ${a.length===1&&a[0].outcome?F`<div class="detail-row">${qo(a[0].outcome)}</div>`:K}
              ...
              `}
              ${w!=="pending"?Ul(d,s.promptCache?.[d]):K}
            </sl-details>
          `})}
      </div>
    </div>
  `}var jl={completed:"success",in_progress:"warning",error:"danger",interrupted:"warning",pending:"neutral"};function fs(e,{onClick:t}={}){let s=e.work_request?.title||"Untitled",n=e.active,u=n?"in_progress":e.stage==="error"?"error":"completed",i=e.started_at&&e.completed_at?Qt(ei(e.started_at,e.completed_at)):e.started_at&&n?Qt(ei(e.started_at,null)):"N/A",o=e.branch||e.work_request?.branch||"",c=e.stages?Object.entries(e.stages):[];return F`
    <div class="run-card" @click=${t?()=>t(e.id):null}>
      ...
      ${c.length>0?F`
        <div class="run-card-stages">
          ${c.map(([p,d])=>{let f=Zt(d.status||"pending",n),v=jl[f]||"neutral",w=p.replace(/_/g," ").toUpperCase();return F`<sl-badge variant="${v}" pill class="run-card-stage-badge">${w}</sl-badge>`})}
        </div>
      `:K}
    </div>
  `}function wr(e,t,{onSelectRun:s}){let n=e.filter(u=>t==="active"?u.active:!u.active);return n.length===0?F`<div class="empty-state">
      ${t==="active"?"No running pipelines":"No completed runs yet"}
    </div>`:F`
    <div class="run-list">
      ${n.map(u=>fs(u,{onClick:s}))}
    </div>
  `}function Go(e,{onSelectRun:t}={}){let s=Object.values(e.runs),n=s.filter(c=>c.active),u=s.filter(c=>!c.active),i=s.filter(c=>(c.stages?Object.values(c.stages):[]).some(d=>d.status==="error")),o=s.length;return F`
    <div class="dashboard">
  ...
  `}var Vl={plan:"planner",coordinate:"coordinator",implement:"implementer",test:"tester",review:"guardian",pr:"guardian"},_s=["plan","coordinate","implement","test","review","pr"],Oi=["planner","coordinator","implementer","tester","guardian"],ql=["opus","sonnet","haiku"],Ri={plan:{agent:"planner",enabled:!0},coordinate:{agent:"coordinator",enabled:!0},implement:{agent:"implementer",enabled:!0},test:{agent:"tester",enabled:!0},review:{agent:"guardian",enabled:!0},pr:{agent:"guardian",enabled:!0}},Xo=[{key:"block_rm_rf",label:"Block rm -rf",description:"Prevent recursive force-delete commands"},{key:"block_env_write",label:"Block .env writes",description:"Prevent writing to .env files"},{key:"block_force_push",label:"Block force push",description:"Prevent git push --force"},{key:"restrict_git_commit",label:"Restrict git commit",description:"Only guardian agent may commit"}],$t={guards:{block_rm_rf:!0,block_env_write:!0,block_force_push:!0,restrict_git_commit:!0},test_gate_strikes:2,dispatch:{planner:[],coordinator:["implementer"],implementer:[],tester:[],guardian:[]}},_e=null,Ge=null,Pt="";async function Sr(){try{let e=await fetch("/api/settings");if(!e.ok)throw new Error(`HTTP ${e.status}`);if(_e=await e.json(),_e.worca||(_e.worca={}),!_e.worca.stages)_e.worca.stages={...Ri};else for(let t of _s)_e.worca.stages[t]||(_e.worca.stages[t]={...Ri[t]});_e.worca.governance?_e.worca.governance={...$t,..._e.worca.governance,guards:{...$t.guards,..._e.worca.governance.guards||{}},dispatch:{...$t.dispatch,..._e.worca.governance.dispatch||{}}}:_e.worca.governance={...$t}}catch(e){_e=null,Ge="error",Pt="Failed to load settings: "+e.message}}async function Cr(e,t){Ge="saving",Pt="",t();try{let s=await fetch("/api/settings",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)});if(!s.ok)throw new Error(`HTTP ${s.status}`);let n=await s.json();_e={worca:n.worca,permissions:n.permissions},Ge="success",Pt="Settings saved successfully"}catch(s){Ge="error",Pt="Failed to save: "+s.message}t(),Ge==="success"&&setTimeout(()=>{Ge==="success"&&(Ge=null,Pt="",t())},3e3)}function Kl(){let e={};for(let t of Oi){let s=document.getElementById(`agent-${t}-model`),n=document.getElementById(`agent-${t}-turns`);e[t]={model:s?.value||"sonnet",max_turns:parseInt(n?.value,10)||30}}return e}function Gl(){let e={};for(let t of["implement_test","code_review","pr_changes","restart_planning"]){let s=document.getElementById(`loop-${t}`);e[t]=parseInt(s?.value,10)||0}return{loops:e}}function Xl(){let e={};for(let t of _s){let s=document.getElementById(`stage-${t}-enabled`),n=document.getElementById(`stage-${t}-agent`);e[t]={agent:n?.value||Ri[t].agent,enabled:s?.checked??!0}}return e}function Yl(){let e={};for(let u of Xo){let i=document.getElementById(`guard-${u.key}`);e[u.key]=i?.checked??!0}let t=document.getElementById("test-gate-strikes"),s=parseInt(t?.value,10)||2,n={};for(let u of Oi){let o=(document.getElementById(`dispatch-${u}`)?.value||"").trim();n[u]=o?o.split(",").map(c=>c.trim()).filter(Boolean):[]}return{guards:e,test_gate_strikes:s,dispatch:n}}function Jl(e,t){let s=e.agents||{};return F`
    <div class="settings-tab-content">
              ...
              <div class="settings-card-body">
                <div class="settings-field">
                  ...
                  <sl-select id="agent-${n}-model" .value="${u.model||"sonnet"}" size="small">
                    ${ql.map(i=>F`<sl-option value="${i}">${i}</sl-option>`)}
                  </sl-select>
                </div>
                <div class="settings-field">
      ...
      <div class="settings-tab-actions">
        <sl-button variant="primary" size="small" @click=${()=>{let n=Kl();Cr({worca:{..._e.worca,agents:n},permissions:_e.permissions},t)}}>
          ${X(Y(Di,14))}
          Save Agents
        </sl-button>
      </div>
    </div>
  `}function Zl(e,t){let s=e.loops||{},n=e.stages||Ri;return F`
    <div class="settings-tab-content">
      <h3 class="settings-section-title">Stage Configuration</h3>
      <div class="pipeline-flow">
        ${_s.map((u,i)=>{let o=n[u]||Ri[u],c=o.enabled!==!1;return F`
            <div class="pipeline-stage-node ${c?"pipeline-stage-node--enabled":"pipeline-stage-node--disabled"}">
              ...
              <div class="settings-field pipeline-stage-field">
                ...
                <sl-select id="stage-${u}-agent" .value="${o.agent||Vl[u]}" size="small">
      ...
      <div class="settings-tab-actions">
        <sl-button variant="primary" size="small" @click=${()=>{let{loops:u}=Gl(),i=Xl();Cr({worca:{..._e.worca,loops:u,stages:i},permissions:_e.permissions},t)}}>
          ${X(Y(Di,14))}
          Save Pipeline
        </sl-button>
      </div>
    </div>
  `}function Ql(e,t,s){let n=e.governance||$t,u=n.guards||$t.guards,i=n.dispatch||$t.dispatch,o=t.allow||[];return F`
    <div class="settings-tab-content">
      ...
      <div class="settings-tab-actions">
        <sl-button variant="primary" size="small" @click=${()=>{let c=Yl();Cr({worca:{..._e.worca,governance:c},permissions:_e.permissions},s)}}>
          ${X(Y(Di,14))}
          Save Governance
        </sl-button>
      </div>
    </div>
  `}function ec(e,t){let s=e?.theme||"light";return F`
    <div class="settings-tab-content">
  ...
  `}function tc(e){return!Ge||Ge==="saving"?K:F`
  ...
  `}function Yo(e,{rerender:t,onThemeToggle:s}){if(!_e)return F`<div class="empty-state">Loading settings\u2026</div>`;let n=_e.worca||{},u=_e.permissions||{};return F`
    ${tc(t)}
    <div class="settings-page">
      <sl-tab-group>
        ...
        <sl-tab-panel name="agents">${Jl(n,t)}</sl-tab-panel>
        <sl-tab-panel name="pipeline">${Zl(n,t)}</sl-tab-panel>
        <sl-tab-panel name="governance">${Ql(n,u,t)}</sl-tab-panel>
        <sl-tab-panel name="preferences">${ec(e,s)}</sl-tab-panel>
      </sl-tab-group>
    </div>
  `}var Ln=["\x1B[36m","\x1B[33m","\x1B[35m","\x1B[32m","\x1B[34m","\x1B[91m","\x1B[96m","\x1B[93m"],Fr="\x1B[0m",Dn="\x1B[2m",ks=new Map,zr=0;function th(e){return ks.has(e)||(ks.set(e,Ln[zr%Ln.length]),zr++),ks.get(e)}var $e=null,It=null,Pi=null,Nr=null,$i=null;async function ih(e){if($e&&e.querySelector(".xterm")){It.fit();return}let[{Terminal:t},{FitAddon:s},{SearchAddon:n}]=await Promise.all([Promise.resolve().then(()=>Tl(Zo(),1)),Promise.resolve().then(()=>(en(),Qo)),Promise.resolve().then(()=>(An(),En))]);$e=new t({theme:{background:"#0f172a",foreground:"#e2e8f0",cursor:"#60a5fa",selectionBackground:"rgba(96, 165, 250, 0.3)"},fontFamily:"'JetBrains Mono', 'SF Mono', 'Fira Code', monospace",fontSize:13,lineHeight:1.4,scrollback:5e4,convertEol:!0,cursorBlink:!1,disableStdin:!0}),It=new s,Pi=new n,$e.loadAddon(It),$e.loadAddon(Pi),$e.open(e),It.fit(),$i=new ResizeObserver(()=>{It&&It.fit()}),$i.observe(e)}function Wr(e){if(!$e)return;let t=e.timestamp?`${Dn}${e.timestamp}${Fr} `:"",s=e.stage?`${th(e.stage)}[${e.stage.toUpperCase()}]${Fr} `:"",n=e.line||e;$e.writeln(`${t}${s}${n}`)}function Ii(){$e&&$e.clear(),ks.clear(),zr=0}function Tn(){$i&&$i.disconnect(),$e&&$e.dispose(),$e=null,It=null,Pi=null,$i=null,Nr=null}function Rn(e){Pi&&e&&Pi.findNext(e,{incremental:!0})}async function On(e){let t=document.getElementById("log-terminal");t&&(e!==Nr&&(Ii(),Nr=e),await ih(t))}function Mn(e){$e&&$e.writeln(`
${Dn}${"\u2500".repeat(40)} Iteration ${e} ${"\u2500".repeat(40)}${Fr}
`)}function Bn(e,{onStageFilter:t,onIterationFilter:s,onSearch:n,onToggleAutoScroll:u,autoScroll:i,stageIterations:o,runStages:c}){let p=c?["orchestrator",...Object.keys(c)]:null,d=[...new Set(["orchestrator",...e.logLines.map(r=>r.stage).filter(Boolean)])],f=p||d,v=e.currentLogStage,w=o?.[v]||0,b=v&&v!=="*"&&w>1;return F`
    <div class="log-viewer-container">
      <div class="log-controls">
        ...
        >
          ${f.map(r=>F`<sl-option value="${r}">${r==="orchestrator"?F`<span style="display:inline-flex;align-items:center;gap:4px">${X(Y(vr,12))} ORCHESTRATOR</span>`:r.toUpperCase()}</sl-option>`)}
        </sl-select>
        ${b?F`
          <sl-select
  ...
  `}var Es=globalThis,As=Es.ShadowRoot&&(Es.ShadyCSS===void 0||Es.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ur=Symbol(),$n=new WeakMap,Hi=class{constructor(t,s,n){if(this._$cssResult$=!0,n!==Ur)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=s}get styleSheet(){let t=this.o,s=this.t;if(As&&t===void 0){let n=s!==void 0&&s.length===1;n&&(t=$n.get(s)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),n&&$n.set(s,t))}return t}toString(){return this.cssText}},Pn=e=>new Hi(typeof e=="string"?e:e+"",void 0,Ur),J=(e,...t)=>{let s=e.length===1?e[0]:t.reduce((n,u,i)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(u)+e[i+1],e[0]);return new Hi(s,e,Ur)},In=(e,t)=>{if(As)e.adoptedStyleSheets=t.map(s=>s instanceof CSSStyleSheet?s:s.styleSheet);else for(let s of t){let n=document.createElement("style"),u=Es.litNonce;u!==void 0&&n.setAttribute("nonce",u),n.textContent=s.cssText,e.appendChild(n)}},jr=As?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let s="";for(let n of t.cssRules)s+=n.cssText;return Pn(s)})(e):e;var{is:sh,defineProperty:rh,getOwnPropertyDescriptor:oh,getOwnPropertyNames:nh,getOwnPropertySymbols:ah,getPrototypeOf:lh}=Object,wt=globalThis,Hn=wt.trustedTypes,ch=Hn?Hn.emptyScript:"",hh=wt.reactiveElementPolyfillSupport,Fi=(e,t)=>e,St={toAttribute(e,t){switch(t){case Boolean:e=e?ch:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let s=e;switch(t){case Boolean:s=e!==null;break;case Number:s=e===null?null:Number(e);break;case Object:case Array:try{s=JSON.parse(e)}catch{s=null}}return s}},Ls=(e,t)=>!sh(e,t),Fn={attribute:!0,type:String,converter:St,reflect:!1,useDefault:!1,hasChanged:Ls};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),wt.litPropertyMetadata??(wt.litPropertyMetadata=new WeakMap);var ht=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??(this.l=[])).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,s=Fn){if(s.state&&(s.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((s=Object.create(s)).wrapped=!0),this.elementProperties.set(t,s),!s.noAccessor){let n=Symbol(),u=this.getPropertyDescriptor(t,n,s);u!==void 0&&rh(this.prototype,t,u)}}static getPropertyDescriptor(t,s,n){let{get:u,set:i}=oh(this.prototype,t)??{get(){return this[s]},set(o){this[s]=o}};return{get:u,set(o){let c=u?.call(this);i?.call(this,o),this.requestUpdate(t,c,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Fn}static _$Ei(){if(this.hasOwnProperty(Fi("elementProperties")))return;let t=lh(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(Fi("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Fi("properties"))){let s=this.properties,n=[...nh(s),...ah(s)];for(let u of n)this.createProperty(u,s[u])}let t=this[Symbol.metadata];if(t!==null){let s=litPropertyMetadata.get(t);if(s!==void 0)for(let[n,u]of s)this.elementProperties.set(n,u)}this._$Eh=new Map;for(let[s,n]of this.elementProperties){let u=this._$Eu(s,n);u!==void 0&&this._$Eh.set(u,s)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){let s=[];if(Array.isArray(t)){let n=new Set(t.flat(1/0).reverse());for(let u of n)s.unshift(jr(u))}else t!==void 0&&s.push(jr(t));return s}static _$Eu(t,s){let n=s.attribute;return n===!1?void 0:typeof n=="string"?n:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??(this._$EO=new Set)).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){let t=new Map,s=this.constructor.elementProperties;for(let n of s.keys())this.hasOwnProperty(n)&&(t.set(n,this[n]),delete this[n]);t.size>0&&(this._$Ep=t)}createRenderRoot(){let t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return In(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,s,n){this._$AK(t,n)}_$ET(t,s){let n=this.constructor.elementProperties.get(t),u=this.constructor._$Eu(t,n);if(u!==void 0&&n.reflect===!0){let i=(n.converter?.toAttribute!==void 0?n.converter:St).toAttribute(s,n.type);this._$Em=t,i==null?this.removeAttribute(u):this.setAttribute(u,i),this._$Em=null}}_$AK(t,s){let n=this.constructor,u=n._$Eh.get(t);if(u!==void 0&&this._$Em!==u){let i=n.getPropertyOptions(u),o=typeof i.converter=="function"?{fromAttribute:i.converter}:i.converter?.fromAttribute!==void 0?i.converter:St;this._$Em=u;let c=o.fromAttribute(s,i.type);this[u]=c??this._$Ej?.get(u)??c,this._$Em=null}}requestUpdate(t,s,n,u=!1,i){if(t!==void 0){let o=this.constructor;if(u===!1&&(i=this[t]),n??(n=o.getPropertyOptions(t)),!((n.hasChanged??Ls)(i,s)||n.useDefault&&n.reflect&&i===this._$Ej?.get(t)&&!this.hasAttribute(o._$Eu(t,n))))return;this.C(t,s,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,s,{useDefault:n,reflect:u,wrapped:i},o){n&&!(this._$Ej??(this._$Ej=new Map)).has(t)&&(this._$Ej.set(t,o??s??this[t]),i!==!0||o!==void 0)||(this._$AL.has(t)||(this.hasUpdated||n||(s=void 0),this._$AL.set(t,s)),u===!0&&this._$Em!==t&&(this._$Eq??(this._$Eq=new Set)).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(s){Promise.reject(s)}let t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(let[u,i]of this._$Ep)this[u]=i;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[u,i]of n){let{wrapped:o}=i,c=this[u];o!==!0||this._$AL.has(u)||c===void 0||this.C(u,void 0,i,c)}}let t=!1,s=this._$AL;try{t=this.shouldUpdate(s),t?(this.willUpdate(s),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(s)):this._$EM()}catch(n){throw t=!1,this._$EM(),n}t&&this._$AE(s)}willUpdate(t){}_$AE(t){this._$EO?.forEach(s=>s.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&(this._$Eq=this._$Eq.forEach(s=>this._$ET(s,this[s]))),this._$EM()}updated(t){}firstUpdated(t){}};ht.elementStyles=[],ht.shadowRootOptions={mode:"open"},ht[Fi("elementProperties")]=new Map,ht[Fi("finalized")]=new Map,hh?.({ReactiveElement:ht}),(wt.reactiveElementVersions??(wt.reactiveElementVersions=[])).push("2.1.2");var zi=globalThis,Ct=class extends ht{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var s;let t=super.createRenderRoot();return(s=this.renderOptions).renderBefore??(s.renderBefore=t.firstChild),t}update(t){let s=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=cs(s,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Te}};Ct._$litElement$=!0,Ct.finalized=!0,zi.litElementHydrateSupport?.({LitElement:Ct});var dh=zi.litElementPolyfillSupport;dh?.({LitElement:Ct});(zi.litElementVersions??(zi.litElementVersions=[])).push("4.2.2");var zn=J`
  :host {
    display: block;
  }
...
`;var Un=Object.defineProperty,uh=Object.defineProperties,ph=Object.getOwnPropertyDescriptor,fh=Object.getOwnPropertyDescriptors,Nn=Object.getOwnPropertySymbols,_h=Object.prototype.hasOwnProperty,mh=Object.prototype.propertyIsEnumerable,Vr=(e,t)=>(t=Symbol[e])?t:Symbol.for("Symbol."+e),qr=e=>{throw TypeError(e)},Wn=(e,t,s)=>t in e?Un(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s,Re=(e,t)=>{for(var s in t||(t={}))_h.call(t,s)&&Wn(e,s,t[s]);if(Nn)for(var s of Nn(t))mh.call(t,s)&&Wn(e,s,t[s]);return e},dt=(e,t)=>uh(e,fh(t)),T=(e,t,s,n)=>{for(var u=n>1?void 0:n?ph(t,s):t,i=e.length-1,o;i>=0;i--)(o=e[i])&&(u=(n?o(t,s,u):o(u))||u);return n&&u&&Un(t,s,u),u},jn=(e,t,s)=>t.has(e)||qr("Cannot "+s),Vn=(e,t,s)=>(jn(e,t,"read from private field"),s?s.call(e):t.get(e)),qn=(e,t,s)=>t.has(e)?qr("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),Kn=(e,t,s,n)=>(jn(e,t,"write to private field"),n?n.call(e,s):t.set(e,s),s),gh=function(e,t){this[0]=e,this[1]=t},Gn=e=>{var t=e[Vr("asyncIterator")],s=!1,n,u={};return t==null?(t=e[Vr("iterator")](),n=i=>u[i]=o=>t[i](o)):(t=t.call(e),n=i=>u[i]=o=>{if(s){if(s=!1,i==="throw")throw o;return o}return s=!0,{done:!1,value:new gh(new Promise(c=>{var p=t[i](o);p instanceof Object||qr("Object expected"),c(p)}),1)}}),u[Vr("iterator")]=()=>u,n("next"),"throw"in t?n("throw"):u.throw=i=>{throw i},"return"in t&&n("return"),u};var Yn=new Map,vh=new WeakMap;function bh(e){return e??{keyframes:[],options:{duration:0}}}function Xn(e,t){return t.toLowerCase()==="rtl"?{keyframes:e.rtlKeyframes||e.keyframes,options:e.options}:e}function we(e,t){Yn.set(e,bh(t))}function Se(e,t,s){let n=vh.get(e);if(n?.[t])return Xn(n[t],s.dir);let u=Yn.get(t);return u?Xn(u,s.dir):{keyframes:[],options:{duration:0}}}function Oe(e,t){return new Promise(s=>{function n(u){u.target===e&&(e.removeEventListener(t,n),s())}e.addEventListener(t,n)})}function Ce(e,t,s){return new Promise(n=>{if(s?.duration===1/0)throw new Error("Promise-based animations must be finite.");let u=e.animate(t,dt(Re({},s),{duration:yh()?0:s.duration}));u.addEventListener("cancel",n,{once:!0}),u.addEventListener("finish",n,{once:!0})})}function Kr(e){return e=e.toString().toLowerCase(),e.indexOf("ms")>-1?parseFloat(e):e.indexOf("s")>-1?parseFloat(e)*1e3:parseFloat(e)}function yh(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}function Ae(e){return Promise.all(e.getAnimations().map(t=>new Promise(s=>{t.cancel(),requestAnimationFrame(s)})))}function Gr(e,t){return e.map(s=>dt(Re({},s),{height:s.height==="auto"?`${t}px`:s.height}))}var Xr=new Set,ri=new Map,Ht,Yr="ltr",Jr="en",Jn=typeof MutationObserver<"u"&&typeof document<"u"&&typeof document.documentElement<"u";if(Jn){let e=new MutationObserver(Zn);Yr=document.documentElement.dir||"ltr",Jr=document.documentElement.lang||navigator.language,e.observe(document.documentElement,{attributes:!0,attributeFilter:["dir","lang"]})}function Ni(...e){e.map(t=>{let s=t.$code.toLowerCase();ri.has(s)?ri.set(s,Object.assign(Object.assign({},ri.get(s)),t)):ri.set(s,t),Ht||(Ht=t)}),Zn()}function Zn(){Jn&&(Yr=document.documentElement.dir||"ltr",Jr=document.documentElement.lang||navigator.language),[...Xr.keys()].map(e=>{typeof e.requestUpdate=="function"&&e.requestUpdate()})}var Ds=class{constructor(t){this.host=t,this.host.addController(this)}hostConnected(){Xr.add(this.host)}hostDisconnected(){Xr.delete(this.host)}dir(){return`${this.host.dir||Yr}`.toLowerCase()}lang(){return`${this.host.lang||Jr}`.toLowerCase()}getTranslationData(t){var s,n;let u=new Intl.Locale(t.replace(/_/g,"-")),i=u?.language.toLowerCase(),o=(n=(s=u?.region)===null||s===void 0?void 0:s.toLowerCase())!==null&&n!==void 0?n:"",c=ri.get(`${i}-${o}`),p=ri.get(i);return{locale:u,language:i,region:o,primary:c,secondary:p}}exists(t,s){var n;let{primary:u,secondary:i}=this.getTranslationData((n=s.lang)!==null&&n!==void 0?n:this.lang());return s=Object.assign({includeFallback:!1},s),!!(u&&u[t]||i&&i[t]||s.includeFallback&&Ht&&Ht[t])}term(t,...s){let{primary:n,secondary:u}=this.getTranslationData(this.lang()),i;if(n&&n[t])i=n[t];else if(u&&u[t])i=u[t];else if(Ht&&Ht[t])i=Ht[t];else return console.error(`No translation found for: ${String(t)}`),String(t);return typeof i=="function"?i(...s):i}date(t,s){return t=new Date(t),new Intl.DateTimeFormat(this.lang(),s).format(t)}number(t,s){return t=Number(t),isNaN(t)?"":new Intl.NumberFormat(this.lang(),s).format(t)}relativeTime(t,s,n){return new Intl.RelativeTimeFormat(this.lang(),n).format(t,s)}};var Qn={$code:"en",$name:"English",$dir:"ltr",carousel:"Carousel",clearEntry:"Clear entry",close:"Close",copied:"Copied",copy:"Copy",currentValue:"Current value",error:"Error",goToSlide:(e,t)=>`Go to slide ${e} of ${t}`,hidePassword:"Hide password",loading:"Loading",nextSlide:"Next slide",numOptionsSelected:e=>e===0?"No options selected":e===1?"1 option selected":`${e} options selected`,previousSlide:"Previous slide",progress:"Progress",remove:"Remove",resize:"Resize",scrollToEnd:"Scroll to end",scrollToStart:"Scroll to start",selectAColorFromTheScreen:"Select a color from the screen",showPassword:"Show password",slideNum:e=>`Slide ${e}`,toggleColorFormat:"Toggle color format"};Ni(Qn);var ea=Qn;var fe=class extends Ds{};Ni(ea);var Zr="";function ta(e){Zr=e}function ia(e=""){if(!Zr){let t=[...document.getElementsByTagName("script")],s=t.find(n=>n.hasAttribute("data-shoelace"));if(s)ta(s.getAttribute("data-shoelace"));else{let n=t.find(i=>/shoelace(\.min)?\.js($|\?)/.test(i.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(i.src)),u="";n&&(u=n.getAttribute("src")),ta(u.split("/").slice(0,-1).join("/"))}}return Zr.replace(/\/$/,"")+(e?`/${e.replace(/^\//,"")}`:"")}var wh={name:"default",resolver:e=>ia(`assets/icons/${e}.svg`)},sa=wh;var ra={caret:`
  ...
  `},Sh={name:"system",resolver:e=>e in ra?`data:image/svg+xml,${encodeURIComponent(ra[e])}`:""},oa=Sh;var Ch=[sa,oa],Qr=[];function na(e){Qr.push(e)}function aa(e){Qr=Qr.filter(t=>t!==e)}function eo(e){return Ch.find(t=>t.name===e)}var la=J`
  :host {
...
`;var xh={attribute:!0,type:String,converter:St,reflect:!1,hasChanged:Ls},kh=(e=xh,t,s)=>{let{kind:n,metadata:u}=s,i=globalThis.litPropertyMetadata.get(u);if(i===void 0&&globalThis.litPropertyMetadata.set(u,i=new Map),n==="setter"&&((e=Object.create(e)).wrapped=!0),i.set(s.name,e),n==="accessor"){let{name:o}=s;return{set(c){let p=t.get.call(this);t.set.call(this,c),this.requestUpdate(o,p,e,!0,c)},init(c){return c!==void 0&&this.C(o,void 0,e,c),c}}}if(n==="setter"){let{name:o}=s;return function(c){let p=this[o];t.call(this,c),this.requestUpdate(o,p,e,!0,c)}}throw Error("Unsupported decorator location: "+n)};function P(e){return(t,s)=>typeof s=="object"?kh(e,t,s):((n,u,i)=>{let o=u.hasOwnProperty(i);return u.constructor.createProperty(i,n),o?Object.getOwnPropertyDescriptor(u,i):void 0})(e,t,s)}function pe(e){return P({...e,state:!0,attribute:!1})}function ca(e){return(t,s)=>{let n=typeof t=="function"?t:t[s];Object.assign(n,e)}}var Ft=(e,t,s)=>(s.configurable=!0,s.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(e,t,s),s);function Z(e,t){return(s,n,u)=>{let i=o=>o.renderRoot?.querySelector(e)??null;if(t){let{get:o,set:c}=typeof n=="object"?s:u??(()=>{let p=Symbol();return{get(){return this[p]},set(d){this[p]=d}}})();return Ft(s,n,{get(){let p=o.call(this);return p===void 0&&(p=i(this),(p!==null||this.hasUpdated)&&c.call(this,p)),p}})}return Ft(s,n,{get(){return i(this)}})}}var Ts,Q=class extends Ct{constructor(){super(),qn(this,Ts,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let s=new CustomEvent(e,Re({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(s),s}static define(e,t=this,s={}){let n=customElements.get(e);if(!n){try{customElements.define(e,t,s)}catch{customElements.define(e,class extends t{},s)}return}let u=" (unknown version)",i=u;"version"in t&&t.version&&(u=" v"+t.version),"version"in n&&n.version&&(i=" v"+n.version),!(u&&i&&u===i)&&console.warn(`Attempted to register <${e}>${u}, but <${e}>${i} has already been registered.`)}attributeChangedCallback(e,t,s){Vn(this,Ts)||(this.constructor.elementProperties.forEach((n,u)=>{n.reflect&&this[u]!=null&&this.initialReflectedProperties.set(u,this[u])}),Kn(this,Ts,!0)),super.attributeChangedCallback(e,t,s)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,s)=>{e.has(s)&&this[s]==null&&(this[s]=t)})}};Ts=new WeakMap;Q.version="2.20.1";Q.dependencies={};T([P()],Q.prototype,"dir",2);T([P()],Q.prototype,"lang",2);var{I:mm}=Po;var ha=(e,t)=>t===void 0?e?._$litType$!==void 0:e?._$litType$===t;var da=e=>e.strings===void 0;var Eh={},ua=(e,t=Eh)=>e._$AH=t;var Wi=Symbol(),Rs=Symbol(),to,io=new Map,be=class extends Q{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(e,t){var s;let n;if(t?.spriteSheet)return this.svg=F`<svg part="svg">
    ...
    `}};We.styles=[oe,zn];We.dependencies={"sl-icon":be};T([Z(".details")],We.prototype,"details",2);T([Z(".details__header")],We.prototype,"header",2);T([Z(".details__body")],We.prototype,"body",2);T([Z(".details__expand-icon-slot")],We.prototype,"expandIconSlot",2);T([P({type:Boolean,reflect:!0})],We.prototype,"open",2);T([P()],We.prototype,"summary",2);T([P({type:Boolean,reflect:!0})],We.prototype,"disabled",2);T([te("open",{waitUntilFirstUpdate:!0})],We.prototype,"handleOpenChange",1);we("details.show",{keyframes:[{height:"0",opacity:"0"},{height:"auto",opacity:"1"}],options:{duration:250,easing:"linear"}});we("details.hide",{keyframes:[{height:"auto",opacity:"1"},{height:"0",opacity:"0"}],options:{duration:250,easing:"linear"}});We.define("sl-details");var pa=J`
  :host {
    display: inline-block;
  }
...
`;var ma=Symbol.for(""),Ah=e=>{if(e?.r===ma)return e?._$litStatic$};var oi=(e,...t)=>({_$litStatic$:t.reduce((s,n,u)=>s+(i=>{if(i._$litStatic$!==void 0)return i._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${i}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(n)+e[u+1],e[0]),r:ma}),_a=new Map,so=e=>(t,...s)=>{let n=s.length,u,i,o=[],c=[],p,d=0,f=!1;for(;d<n;){for(p=t[d];d<n&&(i=s[d],(u=Ah(i))!==void 0);)p+=u+t[++d],f=!0;d!==n&&c.push(i),o.push(p),d++}if(d===n&&o.push(t[n]),f){let v=o.join("$$lit$$");(t=_a.get(v))===void 0&&(o.raw=o,_a.set(v,t=o)),s=c}return e(t,...s)},ni=so(F),kg=so(Oo),Eg=so(Mo);var se=e=>e??K;var ve=class extends Q{constructor(){super(...arguments),this.hasFocus=!1,this.label="",this.disabled=!1}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(e){this.disabled&&(e.preventDefault(),e.stopPropagation())}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}render(){let e=!!this.href,t=e?oi`a`:oi`button`;return ni`
      <${t}
        part="base"
    ...
    `}};xt.styles=[oe,pa];xt.dependencies={"sl-icon-button":ve};T([P({reflect:!0})],xt.prototype,"variant",2);T([P({reflect:!0})],xt.prototype,"size",2);T([P({type:Boolean,reflect:!0})],xt.prototype,"pill",2);T([P({type:Boolean})],xt.prototype,"removable",2);var ga=J`
  :host {
    display: block;
  }
...
`;function Lh(e,t){return{top:Math.round(e.getBoundingClientRect().top-t.getBoundingClientRect().top),left:Math.round(e.getBoundingClientRect().left-t.getBoundingClientRect().left)}}var ro=new Set;function Dh(){let e=document.documentElement.clientWidth;return Math.abs(window.innerWidth-e)}function Th(){let e=Number(getComputedStyle(document.body).paddingRight.replace(/px/,""));return isNaN(e)||!e?0:e}function oo(e){if(ro.add(e),!document.documentElement.classList.contains("sl-scroll-lock")){let t=Dh()+Th(),s=getComputedStyle(document.documentElement).scrollbarGutter;(!s||s==="auto")&&(s="stable"),t<2&&(s=""),document.documentElement.style.setProperty("--sl-scroll-lock-gutter",s),document.documentElement.classList.add("sl-scroll-lock"),document.documentElement.style.setProperty("--sl-scroll-lock-size",`${t}px`)}}function no(e){ro.delete(e),ro.size===0&&(document.documentElement.classList.remove("sl-scroll-lock"),document.documentElement.style.removeProperty("--sl-scroll-lock-size"))}function Ui(e,t,s="vertical",n="smooth"){let u=Lh(e,t),i=u.top+t.scrollTop,o=u.left+t.scrollLeft,c=t.scrollLeft,p=t.scrollLeft+t.offsetWidth,d=t.scrollTop,f=t.scrollTop+t.offsetHeight;(s==="horizontal"||s==="both")&&(o<c?t.scrollTo({left:o,behavior:n}):o+e.clientWidth>p&&t.scrollTo({left:o-t.offsetWidth+e.clientWidth,behavior:n})),(s==="vertical"||s==="both")&&(i<d?t.scrollTo({top:i,behavior:n}):i+e.clientHeight>f&&t.scrollTo({top:i-t.offsetHeight+e.clientHeight,behavior:n}))}var ai=J`
...
`;var st=Math.min,Me=Math.max,Vi=Math.round,qi=Math.floor,Xe=e=>({x:e,y:e}),Rh={left:"right",right:"left",bottom:"top",top:"bottom"};function Ms(e,t,s){return Me(e,st(t,s))}function zt(e,t){return typeof e=="function"?e(t):e}function ut(e){return e.split("-")[0]}function Nt(e){return e.split("-")[1]}function ao(e){return e==="x"?"y":"x"}function Bs(e){return e==="y"?"height":"width"}function rt(e){let t=e[0];return t==="t"||t==="b"?"y":"x"}function $s(e){return ao(rt(e))}function wa(e,t,s){s===void 0&&(s=!1);let n=Nt(e),u=$s(e),i=Bs(u),o=u==="x"?n===(s?"end":"start")?"right":"left":n==="start"?"bottom":"top";return t.reference[i]>t.floating[i]&&(o=ji(o)),[o,ji(o)]}function Sa(e){let t=ji(e);return[Os(e),t,Os(t)]}function Os(e){return e.includes("start")?e.replace("start","end"):e.replace("end","start")}var ba=["left","right"],ya=["right","left"],Oh=["top","bottom"],Mh=["bottom","top"];function Bh(e,t,s){switch(e){case"top":case"bottom":return s?t?ya:ba:t?ba:ya;case"left":case"right":return t?Oh:Mh;default:return[]}}function Ca(e,t,s,n){let u=Nt(e),i=Bh(ut(e),s==="start",n);return u&&(i=i.map(o=>o+"-"+u),t&&(i=i.concat(i.map(Os)))),i}function ji(e){let t=ut(e);return Rh[t]+e.slice(t.length)}function $h(e){return{top:0,right:0,bottom:0,left:0,...e}}function lo(e){return typeof e!="number"?$h(e):{top:e,right:e,bottom:e,left:e}}function Wt(e){let{x:t,y:s,width:n,height:u}=e;return{width:n,height:u,top:s,left:t,right:t+n,bottom:s+u,x:t,y:s}}function xa(e,t,s){let{reference:n,floating:u}=e,i=rt(t),o=$s(t),c=Bs(o),p=ut(t),d=i==="y",f=n.x+n.width/2-u.width/2,v=n.y+n.height/2-u.height/2,w=n[c]/2-u[c]/2,b;switch(p){case"top":b={x:f,y:n.y-u.height};break;case"bottom":b={x:f,y:n.y+n.height};break;case"right":b={x:n.x+n.width,y:v};break;case"left":b={x:n.x-u.width,y:v};break;default:b={x:n.x,y:n.y}}switch(Nt(t)){case"start":b[o]-=w*(s&&d?-1:1);break;case"end":b[o]+=w*(s&&d?-1:1);break}return b}async function ka(e,t){var s;t===void 0&&(t={});let{x:n,y:u,platform:i,rects:o,elements:c,strategy:p}=e,{boundary:d="clippingAncestors",rootBoundary:f="viewport",elementContext:v="floating",altBoundary:w=!1,padding:b=0}=zt(t,e),r=lo(b),a=c[w?v==="floating"?"reference":"floating":v],h=Wt(await i.getClippingRect({element:(s=await(i.isElement==null?void 0:i.isElement(a)))==null||s?a:a.contextElement||await(i.getDocumentElement==null?void 0:i.getDocumentElement(c.floating)),boundary:d,rootBoundary:f,strategy:p})),_=v==="floating"?{x:n,y:u,width:o.floating.width,height:o.floating.height}:o.reference,g=await(i.getOffsetParent==null?void 0:i.getOffsetParent(c.floating)),y=await(i.isElement==null?void 0:i.isElement(g))?await(i.getScale==null?void 0:i.getScale(g))||{x:1,y:1}:{x:1,y:1},x=Wt(i.convertOffsetParentRelativeRectToViewportRelativeRect?await i.convertOffsetParentRelativeRectToViewportRelativeRect({elements:c,rect:_,offsetParent:g,strategy:p}):_);return{top:(h.top-x.top+r.top)/y.y,bottom:(x.bottom-h.bottom+r.bottom)/y.y,left:(h.left-x.left+r.left)/y.x,right:(x.right-h.right+r.right)/y.x}}var Ph=50,Ea=async(e,t,s)=>{let{placement:n="bottom",strategy:u="absolute",middleware:i=[],platform:o}=s,c=o.detectOverflow?o:{...o,detectOverflow:ka},p=await(o.isRTL==null?void 0:o.isRTL(t)),d=await o.getElementRects({reference:e,floating:t,strategy:u}),{x:f,y:v}=xa(d,n,p),w=n,b=0,r={};for(let l=0;l<i.length;l++){let a=i[l];if(!a)continue;let{name:h,fn:_}=a,{x:g,y,data:x,reset:m}=await _({x:f,y:v,initialPlacement:n,placement:w,strategy:u,middlewareData:r,rects:d,platform:c,elements:{reference:e,floating:t}});f=g??f,v=y??v,r[h]={...r[h],...x},m&&b<Ph&&(b++,typeof m=="object"&&(m.placement&&(w=m.placement),m.rects&&(d=m.rects===!0?await o.getElementRects({reference:e,floating:t,strategy:u}):m.rects),{x:f,y:v}=xa(d,w,p)),l=-1)}return{x:f,y:v,placement:w,strategy:u,middlewareData:r}},Aa=e=>({name:"arrow",options:e,async fn(t){let{x:s,y:n,placement:u,rects:i,platform:o,elements:c,middlewareData:p}=t,{element:d,padding:f=0}=zt(e,t)||{};if(d==null)return{};let v=lo(f),w={x:s,y:n},b=$s(u),r=Bs(b),l=await o.getDimensions(d),a=b==="y",h=a?"top":"left",_=a?"bottom":"right",g=a?"clientHeight":"clientWidth",y=i.reference[r]+i.reference[b]-w[b]-i.floating[r],x=w[b]-i.reference[b],m=await(o.getOffsetParent==null?void 0:o.getOffsetParent(d)),S=m?m[g]:0;(!S||!await(o.isElement==null?void 0:o.isElement(m)))&&(S=c.floating[g]||i.floating[r]);let L=y/2-x/2,O=S/2-l[r]/2-1,D=st(v[h],O),M=st(v[_],O),z=D,$=S-l[r]-M,B=S/2-l[r]/2+L,I=Ms(z,B,$),C=!p.arrow&&Nt(u)!=null&&B!==I&&i.reference[r]/2-(B<z?D:M)-l[r]/2<0,E=C?B<z?B-z:B-$:0;return{[b]:w[b]+E,data:{[b]:I,centerOffset:B-I-E,...C&&{alignmentOffset:E}},reset:C}}});var La=function(e){return e===void 0&&(e={}),{name:"flip",options:e,async fn(t){var s,n;let{placement:u,middlewareData:i,rects:o,initialPlacement:c,platform:p,elements:d}=t,{mainAxis:f=!0,crossAxis:v=!0,fallbackPlacements:w,fallbackStrategy:b="bestFit",fallbackAxisSideDirection:r="none",flipAlignment:l=!0,...a}=zt(e,t);if((s=i.arrow)!=null&&s.alignmentOffset)return{};let h=ut(u),_=rt(c),g=ut(c)===c,y=await(p.isRTL==null?void 0:p.isRTL(d.floating)),x=w||(g||!l?[ji(c)]:Sa(c)),m=r!=="none";!w&&m&&x.push(...Ca(c,l,r,y));let S=[c,...x],L=await p.detectOverflow(t,a),O=[],D=((n=i.flip)==null?void 0:n.overflows)||[];if(f&&O.push(L[h]),v){let B=wa(u,o,y);O.push(L[B[0]],L[B[1]])}if(D=[...D,{placement:u,overflows:O}],!O.every(B=>B<=0)){var M,z;let B=(((M=i.flip)==null?void 0:M.index)||0)+1,I=S[B];if(I&&(!(v==="alignment"?_!==rt(I):!1)||D.every(A=>rt(A.placement)===_?A.overflows[0]>0:!0)))return{data:{index:B,overflows:D},reset:{placement:I}};let C=(z=D.filter(E=>E.overflows[0]<=0).sort((E,A)=>E.overflows[1]-A.overflows[1])[0])==null?void 0:z.placement;if(!C)switch(b){case"bestFit":{var $;let E=($=D.filter(A=>{if(m){let R=rt(A.placement);return R===_||R==="y"}return!0}).map(A=>[A.placement,A.overflows.filter(R=>R>0).reduce((R,N)=>R+N,0)]).sort((A,R)=>A[1]-R[1])[0])==null?void 0:$[0];E&&(C=E);break}case"initialPlacement":C=c;break}if(u!==C)return{reset:{placement:C}}}return{}}}};var Ih=new Set(["left","top"]);async function Hh(e,t){let{placement:s,platform:n,elements:u}=e,i=await(n.isRTL==null?void 0:n.isRTL(u.floating)),o=ut(s),c=Nt(s),p=rt(s)==="y",d=Ih.has(o)?-1:1,f=i&&p?-1:1,v=zt(t,e),{mainAxis:w,crossAxis:b,alignmentAxis:r}=typeof v=="number"?{mainAxis:v,crossAxis:0,alignmentAxis:null}:{mainAxis:v.mainAxis||0,crossAxis:v.crossAxis||0,alignmentAxis:v.alignmentAxis};return c&&typeof r=="number"&&(b=c==="end"?r*-1:r),p?{x:b*f,y:w*d}:{x:w*d,y:b*f}}var Da=function(e){return e===void 0&&(e=0),{name:"offset",options:e,async fn(t){var s,n;let{x:u,y:i,placement:o,middlewareData:c}=t,p=await Hh(t,e);return o===((s=c.offset)==null?void 0:s.placement)&&(n=c.arrow)!=null&&n.alignmentOffset?{}:{x:u+p.x,y:i+p.y,data:{...p,placement:o}}}}},Ta=function(e){return e===void 0&&(e={}),{name:"shift",options:e,async fn(t){let{x:s,y:n,placement:u,platform:i}=t,{mainAxis:o=!0,crossAxis:c=!1,limiter:p={fn:h=>{let{x:_,y:g}=h;return{x:_,y:g}}},...d}=zt(e,t),f={x:s,y:n},v=await i.detectOverflow(t,d),w=rt(ut(u)),b=ao(w),r=f[b],l=f[w];if(o){let h=b==="y"?"top":"left",_=b==="y"?"bottom":"right",g=r+v[h],y=r-v[_];r=Ms(g,r,y)}if(c){let h=w==="y"?"top":"left",_=w==="y"?"bottom":"right",g=l+v[h],y=l-v[_];l=Ms(g,l,y)}let a=p.fn({...t,[b]:r,[w]:l});return{...a,data:{x:a.x-s,y:a.y-n,enabled:{[b]:o,[w]:c}}}}}};var Ra=function(e){return e===void 0&&(e={}),{name:"size",options:e,async fn(t){var s,n;let{placement:u,rects:i,platform:o,elements:c}=t,{apply:p=()=>{},...d}=zt(e,t),f=await o.detectOverflow(t,d),v=ut(u),w=Nt(u),b=rt(u)==="y",{width:r,height:l}=i.floating,a,h;v==="top"||v==="bottom"?(a=v,h=w===(await(o.isRTL==null?void 0:o.isRTL(c.floating))?"start":"end")?"left":"right"):(h=v,a=w==="end"?"top":"bottom");let _=l-f.top-f.bottom,g=r-f.left-f.right,y=st(l-f[a],_),x=st(r-f[h],g),m=!t.middlewareData.shift,S=y,L=x;if((s=t.middlewareData.shift)!=null&&s.enabled.x&&(L=g),(n=t.middlewareData.shift)!=null&&n.enabled.y&&(S=_),m&&!w){let D=Me(f.left,0),M=Me(f.right,0),z=Me(f.top,0),$=Me(f.bottom,0);b?L=r-2*(D!==0||M!==0?D+M:Me(f.left,f.right)):S=l-2*(z!==0||$!==0?z+$:Me(f.top,f.bottom))}await p({...t,availableWidth:L,availableHeight:S});let O=await o.getDimensions(c.floating);return r!==O.width||l!==O.height?{reset:{rects:!0}}:{}}}};function Ps(){return typeof window<"u"}function jt(e){return Ma(e)?(e.nodeName||"").toLowerCase():"#document"}function Pe(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function Ye(e){var t;return(t=(Ma(e)?e.ownerDocument:e.document)||window.document)==null?void 0:t.documentElement}function Ma(e){return Ps()?e instanceof Node||e instanceof Pe(e).Node:!1}function Ue(e){return Ps()?e instanceof Element||e instanceof Pe(e).Element:!1}function ot(e){return Ps()?e instanceof HTMLElement||e instanceof Pe(e).HTMLElement:!1}function Oa(e){return!Ps()||typeof ShadowRoot>"u"?!1:e instanceof ShadowRoot||e instanceof Pe(e).ShadowRoot}function ci(e){let{overflow:t,overflowX:s,overflowY:n,display:u}=je(e);return/auto|scroll|overlay|hidden|clip/.test(t+n+s)&&u!=="inline"&&u!=="contents"}function Ba(e){return/^(table|td|th)$/.test(jt(e))}function Ki(e){try{if(e.matches(":popover-open"))return!0}catch{}try{return e.matches(":modal")}catch{return!1}}var Fh=/transform|translate|scale|rotate|perspective|filter/,zh=/paint|layout|strict|content/,Ut=e=>!!e&&e!=="none",co;function hi(e){let t=Ue(e)?je(e):e;return Ut(t.transform)||Ut(t.translate)||Ut(t.scale)||Ut(t.rotate)||Ut(t.perspective)||!Is()&&(Ut(t.backdropFilter)||Ut(t.filter))||Fh.test(t.willChange||"")||zh.test(t.contain||"")}function $a(e){let t=pt(e);for(;ot(t)&&!Vt(t);){if(hi(t))return t;if(Ki(t))return null;t=pt(t)}return null}function Is(){return co==null&&(co=typeof CSS<"u"&&CSS.supports&&CSS.supports("-webkit-backdrop-filter","none")),co}function Vt(e){return/^(html|body|#document)$/.test(jt(e))}function je(e){return Pe(e).getComputedStyle(e)}function Gi(e){return Ue(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function pt(e){if(jt(e)==="html")return e;let t=e.assignedSlot||e.parentNode||Oa(e)&&e.host||Ye(e);return Oa(t)?t.host:t}function Pa(e){let t=pt(e);return Vt(t)?e.ownerDocument?e.ownerDocument.body:e.body:ot(t)&&ci(t)?t:Pa(t)}function li(e,t,s){var n;t===void 0&&(t=[]),s===void 0&&(s=!0);let u=Pa(e),i=u===((n=e.ownerDocument)==null?void 0:n.body),o=Pe(u);if(i){let c=Hs(o);return t.concat(o,o.visualViewport||[],ci(u)?u:[],c&&s?li(c):[])}else return t.concat(u,li(u,[],s))}function Hs(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function za(e){let t=je(e),s=parseFloat(t.width)||0,n=parseFloat(t.height)||0,u=ot(e),i=u?e.offsetWidth:s,o=u?e.offsetHeight:n,c=Vi(s)!==i||Vi(n)!==o;return c&&(s=i,n=o),{width:s,height:n,$:c}}function uo(e){return Ue(e)?e:e.contextElement}function di(e){let t=uo(e);if(!ot(t))return Xe(1);let s=t.getBoundingClientRect(),{width:n,height:u,$:i}=za(t),o=(i?Vi(s.width):s.width)/n,c=(i?Vi(s.height):s.height)/u;return(!o||!Number.isFinite(o))&&(o=1),(!c||!Number.isFinite(c))&&(c=1),{x:o,y:c}}var Nh=Xe(0);function Na(e){let t=Pe(e);return!Is()||!t.visualViewport?Nh:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function Wh(e,t,s){return t===void 0&&(t=!1),!s||t&&s!==Pe(e)?!1:t}function qt(e,t,s,n){t===void 0&&(t=!1),s===void 0&&(s=!1);let u=e.getBoundingClientRect(),i=uo(e),o=Xe(1);t&&(n?Ue(n)&&(o=di(n)):o=di(e));let c=Wh(i,s,n)?Na(i):Xe(0),p=(u.left+c.x)/o.x,d=(u.top+c.y)/o.y,f=u.width/o.x,v=u.height/o.y;if(i){let w=Pe(i),b=n&&Ue(n)?Pe(n):n,r=w,l=Hs(r);for(;l&&n&&b!==r;){let a=di(l),h=l.getBoundingClientRect(),_=je(l),g=h.left+(l.clientLeft+parseFloat(_.paddingLeft))*a.x,y=h.top+(l.clientTop+parseFloat(_.paddingTop))*a.y;p*=a.x,d*=a.y,f*=a.x,v*=a.y,p+=g,d+=y,r=Pe(l),l=Hs(r)}}return Wt({width:f,height:v,x:p,y:d})}function Fs(e,t){let s=Gi(e).scrollLeft;return t?t.left+s:qt(Ye(e)).left+s}function Wa(e,t){let s=e.getBoundingClientRect(),n=s.left+t.scrollLeft-Fs(e,s),u=s.top+t.scrollTop;return{x:n,y:u}}function Uh(e){let{elements:t,rect:s,offsetParent:n,strategy:u}=e,i=u==="fixed",o=Ye(n),c=t?Ki(t.floating):!1;if(n===o||c&&i)return s;let p={scrollLeft:0,scrollTop:0},d=Xe(1),f=Xe(0),v=ot(n);if((v||!v&&!i)&&((jt(n)!=="body"||ci(o))&&(p=Gi(n)),v)){let b=qt(n);d=di(n),f.x=b.x+n.clientLeft,f.y=b.y+n.clientTop}let w=o&&!v&&!i?Wa(o,p):Xe(0);return{width:s.width*d.x,height:s.height*d.y,x:s.x*d.x-p.scrollLeft*d.x+f.x+w.x,y:s.y*d.y-p.scrollTop*d.y+f.y+w.y}}function jh(e){return Array.from(e.getClientRects())}function Vh(e){let t=Ye(e),s=Gi(e),n=e.ownerDocument.body,u=Me(t.scrollWidth,t.clientWidth,n.scrollWidth,n.clientWidth),i=Me(t.scrollHeight,t.clientHeight,n.scrollHeight,n.clientHeight),o=-s.scrollLeft+Fs(e),c=-s.scrollTop;return je(n).direction==="rtl"&&(o+=Me(t.clientWidth,n.clientWidth)-u),{width:u,height:i,x:o,y:c}}var Ia=25;function qh(e,t){let s=Pe(e),n=Ye(e),u=s.visualViewport,i=n.clientWidth,o=n.clientHeight,c=0,p=0;if(u){i=u.width,o=u.height;let f=Is();(!f||f&&t==="fixed")&&(c=u.offsetLeft,p=u.offsetTop)}let d=Fs(n);if(d<=0){let f=n.ownerDocument,v=f.body,w=getComputedStyle(v),b=f.compatMode==="CSS1Compat"&&parseFloat(w.marginLeft)+parseFloat(w.marginRight)||0,r=Math.abs(n.clientWidth-v.clientWidth-b);r<=Ia&&(i-=r)}else d<=Ia&&(i+=d);return{width:i,height:o,x:c,y:p}}function Kh(e,t){let s=qt(e,!0,t==="fixed"),n=s.top+e.clientTop,u=s.left+e.clientLeft,i=ot(e)?di(e):Xe(1),o=e.clientWidth*i.x,c=e.clientHeight*i.y,p=u*i.x,d=n*i.y;return{width:o,height:c,x:p,y:d}}function Ha(e,t,s){let n;if(t==="viewport")n=qh(e,s);else if(t==="document")n=Vh(Ye(e));else if(Ue(t))n=Kh(t,s);else{let u=Na(e);n={x:t.x-u.x,y:t.y-u.y,width:t.width,height:t.height}}return Wt(n)}function Ua(e,t){let s=pt(e);return s===t||!Ue(s)||Vt(s)?!1:je(s).position==="fixed"||Ua(s,t)}function Gh(e,t){let s=t.get(e);if(s)return s;let n=li(e,[],!1).filter(c=>Ue(c)&&jt(c)!=="body"),u=null,i=je(e).position==="fixed",o=i?pt(e):e;for(;Ue(o)&&!Vt(o);){let c=je(o),p=hi(o);!p&&c.position==="fixed"&&(u=null),(i?!p&&!u:!p&&c.position==="static"&&!!u&&(u.position==="absolute"||u.position==="fixed")||ci(o)&&!p&&Ua(e,o))?n=n.filter(f=>f!==o):u=c,o=pt(o)}return t.set(e,n),n}function Xh(e){let{element:t,boundary:s,rootBoundary:n,strategy:u}=e,o=[...s==="clippingAncestors"?Ki(t)?[]:Gh(t,this._c):[].concat(s),n],c=Ha(t,o[0],u),p=c.top,d=c.right,f=c.bottom,v=c.left;for(let w=1;w<o.length;w++){let b=Ha(t,o[w],u);p=Me(b.top,p),d=st(b.right,d),f=st(b.bottom,f),v=Me(b.left,v)}return{width:d-v,height:f-p,x:v,y:p}}function Yh(e){let{width:t,height:s}=za(e);return{width:t,height:s}}function Jh(e,t,s){let n=ot(t),u=Ye(t),i=s==="fixed",o=qt(e,!0,i,t),c={scrollLeft:0,scrollTop:0},p=Xe(0);function d(){p.x=Fs(u)}if(n||!n&&!i)if((jt(t)!=="body"||ci(u))&&(c=Gi(t)),n){let b=qt(t,!0,i,t);p.x=b.x+t.clientLeft,p.y=b.y+t.clientTop}else u&&d();i&&!n&&u&&d();let f=u&&!n&&!i?Wa(u,c):Xe(0),v=o.left+c.scrollLeft-p.x-f.x,w=o.top+c.scrollTop-p.y-f.y;return{x:v,y:w,width:o.width,height:o.height}}function ho(e){return je(e).position==="static"}function Fa(e,t){if(!ot(e)||je(e).position==="fixed")return null;if(t)return t(e);let s=e.offsetParent;return Ye(e)===s&&(s=s.ownerDocument.body),s}function ja(e,t){let s=Pe(e);if(Ki(e))return s;if(!ot(e)){let u=pt(e);for(;u&&!Vt(u);){if(Ue(u)&&!ho(u))return u;u=pt(u)}return s}let n=Fa(e,t);for(;n&&Ba(n)&&ho(n);)n=Fa(n,t);return n&&Vt(n)&&ho(n)&&!hi(n)?s:n||$a(e)||s}var Zh=async function(e){let t=this.getOffsetParent||ja,s=this.getDimensions,n=await s(e.floating);return{reference:Jh(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:n.width,height:n.height}}};function Qh(e){return je(e).direction==="rtl"}var Xi={convertOffsetParentRelativeRectToViewportRelativeRect:Uh,getDocumentElement:Ye,getClippingRect:Xh,getOffsetParent:ja,getElementRects:Zh,getClientRects:jh,getDimensions:Yh,getScale:di,isElement:Ue,isRTL:Qh};function Va(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function ed(e,t){let s=null,n,u=Ye(e);function i(){var c;clearTimeout(n),(c=s)==null||c.disconnect(),s=null}function o(c,p){c===void 0&&(c=!1),p===void 0&&(p=1),i();let d=e.getBoundingClientRect(),{left:f,top:v,width:w,height:b}=d;if(c||t(),!w||!b)return;let r=qi(v),l=qi(u.clientWidth-(f+w)),a=qi(u.clientHeight-(v+b)),h=qi(f),g={rootMargin:-r+"px "+-l+"px "+-a+"px "+-h+"px",threshold:Me(0,st(1,p))||1},y=!0;function x(m){let S=m[0].intersectionRatio;if(S!==p){if(!y)return o();S?o(!1,S):n=setTimeout(()=>{o(!1,1e-7)},1e3)}S===1&&!Va(d,e.getBoundingClientRect())&&o(),y=!1}try{s=new IntersectionObserver(x,{...g,root:u.ownerDocument})}catch{s=new IntersectionObserver(x,g)}s.observe(e)}return o(!0),i}function qa(e,t,s,n){n===void 0&&(n={});let{ancestorScroll:u=!0,ancestorResize:i=!0,elementResize:o=typeof ResizeObserver=="function",layoutShift:c=typeof IntersectionObserver=="function",animationFrame:p=!1}=n,d=uo(e),f=u||i?[...d?li(d):[],...t?li(t):[]]:[];f.forEach(h=>{u&&h.addEventListener("scroll",s,{passive:!0}),i&&h.addEventListener("resize",s)});let v=d&&c?ed(d,s):null,w=-1,b=null;o&&(b=new ResizeObserver(h=>{let[_]=h;_&&_.target===d&&b&&t&&(b.unobserve(t),cancelAnimationFrame(w),w=requestAnimationFrame(()=>{var g;(g=b)==null||g.observe(t)})),s()}),d&&!p&&b.observe(d),t&&b.observe(t));let r,l=p?qt(e):null;p&&a();function a(){let h=qt(e);l&&!Va(l,h)&&s(),l=h,r=requestAnimationFrame(a)}return s(),()=>{var h;f.forEach(_=>{u&&_.removeEventListener("scroll",s),i&&_.removeEventListener("resize",s)}),v?.(),(h=b)==null||h.disconnect(),b=null,p&&cancelAnimationFrame(r)}}var Ka=Da;var Ga=Ta,Xa=La,po=Ra;var Ya=Aa;var Ja=(e,t,s)=>{let n=new Map,u={platform:Xi,...s},i={...u.platform,_c:n};return Ea(e,t,{...u,platform:i})};function Za(e){return td(e)}function fo(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}function td(e){for(let t=e;t;t=fo(t))if(t instanceof Element&&getComputedStyle(t).display==="none")return null;for(let t=fo(e);t;t=fo(t)){if(!(t instanceof Element))continue;let s=getComputedStyle(t);if(s.display!=="contents"&&(s.position!=="static"||hi(s)||t.tagName==="BODY"))return t}return null}function id(e){return e!==null&&typeof e=="object"&&"getBoundingClientRect"in e&&("contextElement"in e?e.contextElement instanceof Element:!0)}var ue=class extends Q{constructor(){super(...arguments),this.localize=new fe(this),this.active=!1,this.placement="top",this.strategy="absolute",this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement="anchor",this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements="",this.flipFallbackStrategy="best-fit",this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl){let e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),s=this.placement.includes("top")||this.placement.includes("bottom"),n=0,u=0,i=0,o=0,c=0,p=0,d=0,f=0;s?e.top<t.top?(n=e.left,u=e.bottom,i=e.right,o=e.bottom,c=t.left,p=t.top,d=t.right,f=t.top):(n=t.left,u=t.bottom,i=t.right,o=t.bottom,c=e.left,p=e.top,d=e.right,f=e.top):e.left<t.left?(n=e.right,u=e.top,i=t.left,o=t.top,c=e.right,p=e.bottom,d=t.left,f=t.bottom):(n=t.right,u=t.top,i=e.left,o=e.top,c=t.right,p=t.bottom,d=e.left,f=e.bottom),this.style.setProperty("--hover-bridge-top-left-x",`${n}px`),this.style.setProperty("--hover-bridge-top-left-y",`${u}px`),this.style.setProperty("--hover-bridge-top-right-x",`${i}px`),this.style.setProperty("--hover-bridge-top-right-y",`${o}px`),this.style.setProperty("--hover-bridge-bottom-left-x",`${c}px`),this.style.setProperty("--hover-bridge-bottom-left-y",`${p}px`),this.style.setProperty("--hover-bridge-bottom-right-x",`${d}px`),this.style.setProperty("--hover-bridge-bottom-right-y",`${f}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has("active")&&(this.active?this.start():this.stop()),e.has("anchor")&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor=="string"){let e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||id(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector('[slot="anchor"]');this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.active&&this.start()}start(){!this.anchorEl||!this.active||(this.cleanup=qa(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute("data-current-placement"),this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height"),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl)return;let e=[Ka({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(po({apply:({rects:s})=>{let n=this.sync==="width"||this.sync==="both",u=this.sync==="height"||this.sync==="both";this.popup.style.width=n?`${s.reference.width}px`:"",this.popup.style.height=u?`${s.reference.height}px`:""}})):(this.popup.style.width="",this.popup.style.height=""),this.flip&&e.push(Xa({boundary:this.flipBoundary,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy==="best-fit"?"bestFit":"initialPlacement",padding:this.flipPadding})),this.shift&&e.push(Ga({boundary:this.shiftBoundary,padding:this.shiftPadding})),this.autoSize?e.push(po({boundary:this.autoSizeBoundary,padding:this.autoSizePadding,apply:({availableWidth:s,availableHeight:n})=>{this.autoSize==="vertical"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-height",`${n}px`):this.style.removeProperty("--auto-size-available-height"),this.autoSize==="horizontal"||this.autoSize==="both"?this.style.setProperty("--auto-size-available-width",`${s}px`):this.style.removeProperty("--auto-size-available-width")}})):(this.style.removeProperty("--auto-size-available-width"),this.style.removeProperty("--auto-size-available-height")),this.arrow&&e.push(Ya({element:this.arrowEl,padding:this.arrowPadding}));let t=this.strategy==="absolute"?s=>Xi.getOffsetParent(s,Za):Xi.getOffsetParent;Ja(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:this.strategy,platform:dt(Re({},Xi),{getOffsetParent:t})}).then(({x:s,y:n,middlewareData:u,placement:i})=>{let o=this.localize.dir()==="rtl",c={top:"bottom",right:"left",bottom:"top",left:"right"}[i.split("-")[0]];if(this.setAttribute("data-current-placement",i),Object.assign(this.popup.style,{left:`${s}px`,top:`${n}px`}),this.arrow){let p=u.arrow.x,d=u.arrow.y,f="",v="",w="",b="";if(this.arrowPlacement==="start"){let r=typeof p=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";f=typeof d=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"",v=o?r:"",b=o?"":r}else if(this.arrowPlacement==="end"){let r=typeof p=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:"";v=o?"":r,b=o?r:"",w=typeof d=="number"?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:""}else this.arrowPlacement==="center"?(b=typeof p=="number"?"calc(50% - var(--arrow-size-diagonal))":"",f=typeof d=="number"?"calc(50% - var(--arrow-size-diagonal))":""):(b=typeof p=="number"?`${p}px`:"",f=typeof d=="number"?`${d}px`:"");Object.assign(this.arrowEl.style,{top:f,right:v,bottom:w,left:b,[c]:"calc(var(--arrow-size-diagonal) * -1)"})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.emit("sl-reposition")}render(){return F`
...
`;var mo=class extends Q{constructor(){super(...arguments),this.localize=new fe(this)}render(){return F`
      <svg part="base" class="spinner" role="progressbar" aria-label=${this.localize.term("loading")}>
        <circle class="spinner__track"></circle>
        <circle class="spinner__indicator"></circle>
      </svg>
    `}};mo.styles=[oe,tl];var il=J`
  :host {
    display: inline-block;
    position: relative;
    width: auto;
...
`;var ce=class extends Q{constructor(){super(...arguments),this.formControlController=new kt(this,{assumeInteractionOn:["click"]}),this.hasSlotController=new Ve(this,"[default]","prefix","suffix"),this.localize=new fe(this),this.hasFocus=!1,this.invalid=!1,this.title="",this.variant="default",this.size="medium",this.caret=!1,this.disabled=!1,this.loading=!1,this.outline=!1,this.pill=!1,this.circle=!1,this.type="button",this.name="",this.value="",this.href="",this.rel="noreferrer noopener"}get validity(){return this.isButton()?this.button.validity:Ns}get validationMessage(){return this.isButton()?this.button.validationMessage:""}firstUpdated(){this.isButton()&&this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleClick(){this.type==="submit"&&this.formControlController.submit(this),this.type==="reset"&&this.formControlController.reset(this)}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}isButton(){return!this.href}isLink(){return!!this.href}handleDisabledChange(){this.isButton()&&this.formControlController.setValidity(this.disabled)}click(){this.button.click()}focus(e){this.button.focus(e)}blur(){this.button.blur()}checkValidity(){return this.isButton()?this.button.checkValidity():!0}getForm(){return this.formControlController.getForm()}reportValidity(){return this.isButton()?this.button.reportValidity():!0}setCustomValidity(e){this.isButton()&&(this.button.setCustomValidity(e),this.formControlController.updateValidity())}render(){let e=this.isLink(),t=e?oi`a`:oi`button`;return ni`
    ...
    `}};ce.styles=[oe,il];ce.dependencies={"sl-icon":be,"sl-spinner":mo};T([Z(".button")],ce.prototype,"button",2);T([pe()],ce.prototype,"hasFocus",2);T([pe()],ce.prototype,"invalid",2);T([P()],ce.prototype,"title",2);T([P({reflect:!0})],ce.prototype,"variant",2);T([P({reflect:!0})],ce.prototype,"size",2);T([P({type:Boolean,reflect:!0})],ce.prototype,"caret",2);T([P({type:Boolean,reflect:!0})],ce.prototype,"disabled",2);T([P({type:Boolean,reflect:!0})],ce.prototype,"loading",2);T([P({type:Boolean,reflect:!0})],ce.prototype,"outline",2);T([P({type:Boolean,reflect:!0})],ce.prototype,"pill",2);T([P({type:Boolean,reflect:!0})],ce.prototype,"circle",2);T([P()],ce.prototype,"type",2);T([P()],ce.prototype,"name",2);T([P()],ce.prototype,"value",2);T([P()],ce.prototype,"href",2);T([P()],ce.prototype,"target",2);T([P()],ce.prototype,"rel",2);T([P()],ce.prototype,"download",2);T([P()],ce.prototype,"form",2);T([P({attribute:"formaction"})],ce.prototype,"formAction",2);T([P({attribute:"formenctype"})],ce.prototype,"formEnctype",2);T([P({attribute:"formmethod"})],ce.prototype,"formMethod",2);T([P({attribute:"formnovalidate",type:Boolean})],ce.prototype,"formNoValidate",2);T([P({attribute:"formtarget"})],ce.prototype,"formTarget",2);T([te("disabled",{waitUntilFirstUpdate:!0})],ce.prototype,"handleDisabledChange",1);ce.define("sl-button");var sl=J`
  :host {
    display: inline-flex;
  }
...
`;var ui=class extends Q{constructor(){super(...arguments),this.variant="primary",this.pill=!1,this.pulse=!1}render(){return F`
    ...
    `}};ui.styles=[oe,sl];T([P({reflect:!0})],ui.prototype,"variant",2);T([P({type:Boolean,reflect:!0})],ui.prototype,"pill",2);T([P({type:Boolean,reflect:!0})],ui.prototype,"pulse",2);ui.define("sl-badge");var rl=J`
  :host {
    --max-width: 20rem;
    --hide-delay: 0ms;
    --show-delay: 150ms;
...
`;var xe=class extends Q{constructor(){super(),this.localize=new fe(this),this.content="",this.placement="top",this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.trigger="hover focus",this.hoist=!1,this.handleBlur=()=>{this.hasTrigger("focus")&&this.hide()},this.handleClick=()=>{this.hasTrigger("click")&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger("focus")&&this.show()},this.handleDocumentKeyDown=e=>{e.key==="Escape"&&(e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{if(this.hasTrigger("hover")){let e=Kr(getComputedStyle(this).getPropertyValue("--show-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),e)}},this.handleMouseOut=()=>{if(this.hasTrigger("hover")){let e=Kr(getComputedStyle(this).getPropertyValue("--hide-delay"));clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.hide(),e)}},this.addEventListener("blur",this.handleBlur,!0),this.addEventListener("focus",this.handleFocus,!0),this.addEventListener("click",this.handleClick),this.addEventListener("mouseover",this.handleMouseOver),this.addEventListener("mouseout",this.handleMouseOut)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.closeWatcher)==null||e.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(" ").includes(e)}async handleOpenChange(){var e,t;if(this.open){if(this.disabled)return;this.emit("sl-show"),"CloseWatcher"in window?((e=this.closeWatcher)==null||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>{this.hide()}):document.addEventListener("keydown",this.handleDocumentKeyDown),await Ae(this.body),this.body.hidden=!1,this.popup.active=!0;let{keyframes:s,options:n}=Se(this,"tooltip.show",{dir:this.localize.dir()});await Ce(this.popup.popup,s,n),this.popup.reposition(),this.emit("sl-after-show")}else{this.emit("sl-hide"),(t=this.closeWatcher)==null||t.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown),await Ae(this.body);let{keyframes:s,options:n}=Se(this,"tooltip.hide",{dir:this.localize.dir()});await Ce(this.popup.popup,s,n),this.popup.active=!1,this.body.hidden=!0,this.emit("sl-after-hide")}}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,Oe(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,Oe(this,"sl-after-hide")}render(){return F`
    ...
    `}};xe.styles=[oe,rl];xe.dependencies={"sl-popup":ue};T([Z("slot:not([name])")],xe.prototype,"defaultSlot",2);T([Z(".tooltip__body")],xe.prototype,"body",2);T([Z("sl-popup")],xe.prototype,"popup",2);T([P()],xe.prototype,"content",2);T([P()],xe.prototype,"placement",2);T([P({type:Boolean,reflect:!0})],xe.prototype,"disabled",2);T([P({type:Number})],xe.prototype,"distance",2);T([P({type:Boolean,reflect:!0})],xe.prototype,"open",2);T([P({type:Number})],xe.prototype,"skidding",2);T([P()],xe.prototype,"trigger",2);T([P({type:Boolean})],xe.prototype,"hoist",2);T([te("open",{waitUntilFirstUpdate:!0})],xe.prototype,"handleOpenChange",1);T([te(["content","distance","hoist","placement","skidding"])],xe.prototype,"handleOptionsChange",1);T([te("disabled")],xe.prototype,"handleDisabledChange",1);we("tooltip.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:150,easing:"ease"}});we("tooltip.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:150,easing:"ease"}});xe.define("sl-tooltip");function*js(e=document.activeElement){e!=null&&(yield e,"shadowRoot"in e&&e.shadowRoot&&e.shadowRoot.mode!=="closed"&&(yield*Gn(js(e.shadowRoot.activeElement))))}function nl(){return[...js()].pop()}var ol=new WeakMap;function al(e){let t=ol.get(e);return t||(t=window.getComputedStyle(e,null),ol.set(e,t)),t}function sd(e){if(typeof e.checkVisibility=="function")return e.checkVisibility({checkOpacity:!1,checkVisibilityCSS:!0});let t=al(e);return t.visibility!=="hidden"&&t.display!=="none"}function rd(e){let t=al(e),{overflowY:s,overflowX:n}=t;return s==="scroll"||n==="scroll"?!0:s!=="auto"||n!=="auto"?!1:e.scrollHeight>e.clientHeight&&s==="auto"||e.scrollWidth>e.clientWidth&&n==="auto"}function od(e){let t=e.tagName.toLowerCase(),s=Number(e.getAttribute("tabindex"));if(e.hasAttribute("tabindex")&&(isNaN(s)||s<=-1)||e.hasAttribute("disabled")||e.closest("[inert]"))return!1;if(t==="input"&&e.getAttribute("type")==="radio"){let i=e.getRootNode(),o=`input[type='radio'][name="${e.getAttribute("name")}"]`,c=i.querySelector(`${o}:checked`);return c?c===e:i.querySelector(o)===e}return sd(e)?(t==="audio"||t==="video")&&e.hasAttribute("controls")||e.hasAttribute("tabindex")||e.hasAttribute("contenteditable")&&e.getAttribute("contenteditable")!=="false"||["button","input","select","textarea","a","audio","video","summary","iframe"].includes(t)?!0:rd(e):!1}function nd(e,t){var s;return((s=e.getRootNode({composed:!0}))==null?void 0:s.host)!==t}function go(e){let t=new WeakMap,s=[];function n(u){if(u instanceof Element){if(u.hasAttribute("inert")||u.closest("[inert]")||t.has(u))return;t.set(u,!0),!s.includes(u)&&od(u)&&s.push(u),u instanceof HTMLSlotElement&&nd(u,e)&&u.assignedElements({flatten:!0}).forEach(i=>{n(i)}),u.shadowRoot!==null&&u.shadowRoot.mode==="open"&&n(u.shadowRoot)}for(let i of u.children)n(i)}return n(e),s.sort((u,i)=>{let o=Number(u.getAttribute("tabindex"))||0;return(Number(i.getAttribute("tabindex"))||0)-o})}var Qi=[],ll=class{constructor(e){this.tabDirection="forward",this.handleFocusIn=()=>{this.isActive()&&this.checkFocus()},this.handleKeyDown=t=>{var s;if(t.key!=="Tab"||this.isExternalActivated||!this.isActive())return;let n=nl();if(this.previousFocus=n,this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus))return;t.shiftKey?this.tabDirection="backward":this.tabDirection="forward";let u=go(this.element),i=u.findIndex(c=>c===n);this.previousFocus=this.currentFocus;let o=this.tabDirection==="forward"?1:-1;for(;;){i+o>=u.length?i=0:i+o<0?i=u.length-1:i+=o,this.previousFocus=this.currentFocus;let c=u[i];if(this.tabDirection==="backward"&&this.previousFocus&&this.possiblyHasTabbableChildren(this.previousFocus)||c&&this.possiblyHasTabbableChildren(c))return;t.preventDefault(),this.currentFocus=c,(s=this.currentFocus)==null||s.focus({preventScroll:!1});let p=[...js()];if(p.includes(this.currentFocus)||!p.includes(this.previousFocus))break}setTimeout(()=>this.checkFocus())},this.handleKeyUp=()=>{this.tabDirection="forward"},this.element=e,this.elementsWithTabbableControls=["iframe"]}activate(){Qi.push(this.element),document.addEventListener("focusin",this.handleFocusIn),document.addEventListener("keydown",this.handleKeyDown),document.addEventListener("keyup",this.handleKeyUp)}deactivate(){Qi=Qi.filter(e=>e!==this.element),this.currentFocus=null,document.removeEventListener("focusin",this.handleFocusIn),document.removeEventListener("keydown",this.handleKeyDown),document.removeEventListener("keyup",this.handleKeyUp)}isActive(){return Qi[Qi.length-1]===this.element}activateExternal(){this.isExternalActivated=!0}deactivateExternal(){this.isExternalActivated=!1}checkFocus(){if(this.isActive()&&!this.isExternalActivated){let e=go(this.element);if(!this.element.matches(":focus-within")){let t=e[0],s=e[e.length-1],n=this.tabDirection==="forward"?t:s;typeof n?.focus=="function"&&(this.currentFocus=n,n.focus({preventScroll:!1}))}}}possiblyHasTabbableChildren(e){return this.elementsWithTabbableControls.includes(e.tagName.toLowerCase())||e.hasAttribute("controls")}};var cl=J`
  :host {
    --width: 31rem;
...
`;var Vs=e=>{var t;let{activeElement:s}=document;s&&e.contains(s)&&((t=document.activeElement)==null||t.blur())};var Je=class extends Q{constructor(){super(...arguments),this.hasSlotController=new Ve(this,"footer"),this.localize=new fe(this),this.modal=new ll(this),this.open=!1,this.label="",this.noHeader=!1,this.handleDocumentKeyDown=e=>{e.key==="Escape"&&this.modal.isActive()&&this.open&&(e.stopPropagation(),this.requestClose("keyboard"))}}firstUpdated(){this.dialog.hidden=!this.open,this.open&&(this.addOpenListeners(),this.modal.activate(),oo(this))}disconnectedCallback(){super.disconnectedCallback(),this.modal.deactivate(),no(this),this.removeOpenListeners()}requestClose(e){if(this.emit("sl-request-close",{cancelable:!0,detail:{source:e}}).defaultPrevented){let s=Se(this,"dialog.denyClose",{dir:this.localize.dir()});Ce(this.panel,s.keyframes,s.options);return}this.hide()}addOpenListeners(){var e;"CloseWatcher"in window?((e=this.closeWatcher)==null||e.destroy(),this.closeWatcher=new CloseWatcher,this.closeWatcher.onclose=()=>this.requestClose("keyboard")):document.addEventListener("keydown",this.handleDocumentKeyDown)}removeOpenListeners(){var e;(e=this.closeWatcher)==null||e.destroy(),document.removeEventListener("keydown",this.handleDocumentKeyDown)}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.addOpenListeners(),this.originalTrigger=document.activeElement,this.modal.activate(),oo(this);let e=this.querySelector("[autofocus]");e&&e.removeAttribute("autofocus"),await Promise.all([Ae(this.dialog),Ae(this.overlay)]),this.dialog.hidden=!1,requestAnimationFrame(()=>{this.emit("sl-initial-focus",{cancelable:!0}).defaultPrevented||(e?e.focus({preventScroll:!0}):this.panel.focus({preventScroll:!0})),e&&e.setAttribute("autofocus","")});let t=Se(this,"dialog.show",{dir:this.localize.dir()}),s=Se(this,"dialog.overlay.show",{dir:this.localize.dir()});await Promise.all([Ce(this.panel,t.keyframes,t.options),Ce(this.overlay,s.keyframes,s.options)]),this.emit("sl-after-show")}else{Vs(this),this.emit("sl-hide"),this.removeOpenListeners(),this.modal.deactivate(),await Promise.all([Ae(this.dialog),Ae(this.overlay)]);let e=Se(this,"dialog.hide",{dir:this.localize.dir()}),t=Se(this,"dialog.overlay.hide",{dir:this.localize.dir()});await Promise.all([Ce(this.overlay,t.keyframes,t.options).then(()=>{this.overlay.hidden=!0}),Ce(this.panel,e.keyframes,e.options).then(()=>{this.panel.hidden=!0})]),this.dialog.hidden=!0,this.overlay.hidden=!1,this.panel.hidden=!1,no(this);let s=this.originalTrigger;typeof s?.focus=="function"&&setTimeout(()=>s.focus()),this.emit("sl-after-hide")}}async show(){if(!this.open)return this.open=!0,Oe(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,Oe(this,"sl-after-hide")}render(){return F`
    ...
    `}};Je.styles=[oe,cl];Je.dependencies={"sl-icon-button":ve};T([Z(".dialog")],Je.prototype,"dialog",2);T([Z(".dialog__panel")],Je.prototype,"panel",2);T([Z(".dialog__overlay")],Je.prototype,"overlay",2);T([P({type:Boolean,reflect:!0})],Je.prototype,"open",2);T([P({reflect:!0})],Je.prototype,"label",2);T([P({attribute:"no-header",type:Boolean,reflect:!0})],Je.prototype,"noHeader",2);T([te("open",{waitUntilFirstUpdate:!0})],Je.prototype,"handleOpenChange",1);we("dialog.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});we("dialog.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});we("dialog.denyClose",{keyframes:[{scale:1},{scale:1.02},{scale:1}],options:{duration:250}});we("dialog.overlay.show",{keyframes:[{opacity:0},{opacity:1}],options:{duration:250}});we("dialog.overlay.hide",{keyframes:[{opacity:1},{opacity:0}],options:{duration:250}});Je.define("sl-dialog");var hl=J`
  :host {
    --indicator-color: var(--sl-color-primary-600);
...
`;var es=class extends Q{constructor(){super(...arguments),this.observedElements=[],this.disabled=!1}connectedCallback(){super.connectedCallback(),this.resizeObserver=new ResizeObserver(e=>{this.emit("sl-resize",{detail:{entries:e}})}),this.disabled||this.startObserver()}disconnectedCallback(){super.disconnectedCallback(),this.stopObserver()}handleSlotChange(){this.disabled||this.startObserver()}startObserver(){let e=this.shadowRoot.querySelector("slot");if(e!==null){let t=e.assignedElements({flatten:!0});this.observedElements.forEach(s=>this.resizeObserver.unobserve(s)),this.observedElements=[],t.forEach(s=>{this.resizeObserver.observe(s),this.observedElements.push(s)})}}stopObserver(){this.resizeObserver.disconnect()}handleDisabledChange(){this.disabled?this.stopObserver():this.startObserver()}render(){return F` <slot @slotchange=${this.handleSlotChange}></slot> `}};es.styles=[oe,dl];T([P({type:Boolean,reflect:!0})],es.prototype,"disabled",2);T([te("disabled",{waitUntilFirstUpdate:!0})],es.prototype,"handleDisabledChange",1);var ke=class extends Q{constructor(){super(...arguments),this.tabs=[],this.focusableTabs=[],this.panels=[],this.localize=new fe(this),this.hasScrollControls=!1,this.shouldHideScrollStartButton=!1,this.shouldHideScrollEndButton=!1,this.placement="top",this.activation="auto",this.noScrollControls=!1,this.fixedScrollControls=!1,this.scrollOffset=1}connectedCallback(){let e=Promise.all([customElements.whenDefined("sl-tab"),customElements.whenDefined("sl-tab-panel")]);super.connectedCallback(),this.resizeObserver=new ResizeObserver(()=>{this.repositionIndicator(),this.updateScrollControls()}),this.mutationObserver=new MutationObserver(t=>{let s=t.filter(({target:n})=>{if(n===this)return!0;if(n.closest("sl-tab-group")!==this)return!1;let u=n.tagName.toLowerCase();return u==="sl-tab"||u==="sl-tab-panel"});if(s.length!==0){if(s.some(n=>!["aria-labelledby","aria-controls"].includes(n.attributeName))&&setTimeout(()=>this.setAriaLabels()),s.some(n=>n.attributeName==="disabled"))this.syncTabsAndPanels();else if(s.some(n=>n.attributeName==="active")){let u=s.filter(i=>i.attributeName==="active"&&i.target.tagName.toLowerCase()==="sl-tab").map(i=>i.target).find(i=>i.active);u&&this.setActiveTab(u)}}}),this.updateComplete.then(()=>{this.syncTabsAndPanels(),this.mutationObserver.observe(this,{attributes:!0,attributeFilter:["active","disabled","name","panel"],childList:!0,subtree:!0}),this.resizeObserver.observe(this.nav),e.then(()=>{new IntersectionObserver((s,n)=>{var u;s[0].intersectionRatio>0&&(this.setAriaLabels(),this.setActiveTab((u=this.getActiveTab())!=null?u:this.tabs[0],{emitEvents:!1}),n.unobserve(s[0].target))}).observe(this.tabGroup)})})}disconnectedCallback(){var e,t;super.disconnectedCallback(),(e=this.mutationObserver)==null||e.disconnect(),this.nav&&((t=this.resizeObserver)==null||t.unobserve(this.nav))}getAllTabs(){return this.shadowRoot.querySelector('slot[name="nav"]').assignedElements()}getAllPanels(){return[...this.body.assignedElements()].filter(e=>e.tagName.toLowerCase()==="sl-tab-panel")}getActiveTab(){return this.tabs.find(e=>e.active)}handleClick(e){let s=e.target.closest("sl-tab");s?.closest("sl-tab-group")===this&&s!==null&&this.setActiveTab(s,{scrollBehavior:"smooth"})}handleKeyDown(e){let s=e.target.closest("sl-tab");if(s?.closest("sl-tab-group")===this&&(["Enter"," "].includes(e.key)&&s!==null&&(this.setActiveTab(s,{scrollBehavior:"smooth"}),e.preventDefault()),["ArrowLeft","ArrowRight","ArrowUp","ArrowDown","Home","End"].includes(e.key))){let u=this.tabs.find(c=>c.matches(":focus")),i=this.localize.dir()==="rtl",o=null;if(u?.tagName.toLowerCase()==="sl-tab"){if(e.key==="Home")o=this.focusableTabs[0];else if(e.key==="End")o=this.focusableTabs[this.focusableTabs.length-1];else if(["top","bottom"].includes(this.placement)&&e.key===(i?"ArrowRight":"ArrowLeft")||["start","end"].includes(this.placement)&&e.key==="ArrowUp"){let c=this.tabs.findIndex(p=>p===u);o=this.findNextFocusableTab(c,"backward")}else if(["top","bottom"].includes(this.placement)&&e.key===(i?"ArrowLeft":"ArrowRight")||["start","end"].includes(this.placement)&&e.key==="ArrowDown"){let c=this.tabs.findIndex(p=>p===u);o=this.findNextFocusableTab(c,"forward")}if(!o)return;o.tabIndex=0,o.focus({preventScroll:!0}),this.activation==="auto"?this.setActiveTab(o,{scrollBehavior:"smooth"}):this.tabs.forEach(c=>{c.tabIndex=c===o?0:-1}),["top","bottom"].includes(this.placement)&&Ui(o,this.nav,"horizontal"),e.preventDefault()}}}handleScrollToStart(){this.nav.scroll({left:this.localize.dir()==="rtl"?this.nav.scrollLeft+this.nav.clientWidth:this.nav.scrollLeft-this.nav.clientWidth,behavior:"smooth"})}handleScrollToEnd(){this.nav.scroll({left:this.localize.dir()==="rtl"?this.nav.scrollLeft-this.nav.clientWidth:this.nav.scrollLeft+this.nav.clientWidth,behavior:"smooth"})}setActiveTab(e,t){if(t=Re({emitEvents:!0,scrollBehavior:"auto"},t),e!==this.activeTab&&!e.disabled){let s=this.activeTab;this.activeTab=e,this.tabs.forEach(n=>{n.active=n===this.activeTab,n.tabIndex=n===this.activeTab?0:-1}),this.panels.forEach(n=>{var u;return n.active=n.name===((u=this.activeTab)==null?void 0:u.panel)}),this.syncIndicator(),["top","bottom"].includes(this.placement)&&Ui(this.activeTab,this.nav,"horizontal",t.scrollBehavior),t.emitEvents&&(s&&this.emit("sl-tab-hide",{detail:{name:s.panel}}),this.emit("sl-tab-show",{detail:{name:this.activeTab.panel}}))}}setAriaLabels(){this.tabs.forEach(e=>{let t=this.panels.find(s=>s.name===e.panel);t&&(e.setAttribute("aria-controls",t.getAttribute("id")),t.setAttribute("aria-labelledby",e.getAttribute("id")))})}repositionIndicator(){let e=this.getActiveTab();if(!e)return;let t=e.clientWidth,s=e.clientHeight,n=this.localize.dir()==="rtl",u=this.getAllTabs(),o=u.slice(0,u.indexOf(e)).reduce((c,p)=>({left:c.left+p.clientWidth,top:c.top+p.clientHeight}),{left:0,top:0});switch(this.placement){case"top":case"bottom":this.indicator.style.width=`${t}px`,this.indicator.style.height="auto",this.indicator.style.translate=n?`${-1*o.left}px`:`${o.left}px`;break;case"start":case"end":this.indicator.style.width="auto",this.indicator.style.height=`${s}px`,this.indicator.style.translate=`0 ${o.top}px`;break}}syncTabsAndPanels(){this.tabs=this.getAllTabs(),this.focusableTabs=this.tabs.filter(e=>!e.disabled),this.panels=this.getAllPanels(),this.syncIndicator(),this.updateComplete.then(()=>this.updateScrollControls())}findNextFocusableTab(e,t){let s=null,n=t==="forward"?1:-1,u=e+n;for(;e<this.tabs.length;){if(s=this.tabs[u]||null,s===null){t==="forward"?s=this.focusableTabs[0]:s=this.focusableTabs[this.focusableTabs.length-1];break}if(!s.disabled)break;u+=n}return s}updateScrollButtons(){this.hasScrollControls&&!this.fixedScrollControls&&(this.shouldHideScrollStartButton=this.scrollFromStart()<=this.scrollOffset,this.shouldHideScrollEndButton=this.isScrolledToEnd())}isScrolledToEnd(){return this.scrollFromStart()+this.nav.clientWidth>=this.nav.scrollWidth-this.scrollOffset}scrollFromStart(){return this.localize.dir()==="rtl"?-this.nav.scrollLeft:this.nav.scrollLeft}updateScrollControls(){this.noScrollControls?this.hasScrollControls=!1:this.hasScrollControls=["top","bottom"].includes(this.placement)&&this.nav.scrollWidth>this.nav.clientWidth+1,this.updateScrollButtons()}syncIndicator(){this.getActiveTab()?(this.indicator.style.display="block",this.repositionIndicator()):this.indicator.style.display="none"}show(e){let t=this.tabs.find(s=>s.panel===e);t&&this.setActiveTab(t,{scrollBehavior:"smooth"})}render(){let e=this.localize.dir()==="rtl";return F`
    ...
    `}};ke.styles=[oe,hl];ke.dependencies={"sl-icon-button":ve,"sl-resize-observer":es};T([Z(".tab-group")],ke.prototype,"tabGroup",2);T([Z(".tab-group__body")],ke.prototype,"body",2);T([Z(".tab-group__nav")],ke.prototype,"nav",2);T([Z(".tab-group__indicator")],ke.prototype,"indicator",2);T([pe()],ke.prototype,"hasScrollControls",2);T([pe()],ke.prototype,"shouldHideScrollStartButton",2);T([pe()],ke.prototype,"shouldHideScrollEndButton",2);T([P()],ke.prototype,"placement",2);T([P()],ke.prototype,"activation",2);T([P({attribute:"no-scroll-controls",type:Boolean})],ke.prototype,"noScrollControls",2);T([P({attribute:"fixed-scroll-controls",type:Boolean})],ke.prototype,"fixedScrollControls",2);T([ca({passive:!0})],ke.prototype,"updateScrollButtons",1);T([te("noScrollControls",{waitUntilFirstUpdate:!0})],ke.prototype,"updateScrollControls",1);T([te("placement",{waitUntilFirstUpdate:!0})],ke.prototype,"syncIndicator",1);ke.define("sl-tab-group");var ad=(e,t)=>{let s=0;return function(...n){window.clearTimeout(s),s=window.setTimeout(()=>{e.call(this,...n)},t)}},ul=(e,t,s)=>{let n=e[t];e[t]=function(...u){n.call(this,...u),s.call(this,n,...u)}};(()=>{if(typeof window>"u")return;if(!("onscrollend"in window)){let t=new Set,s=new WeakMap,n=i=>{for(let o of i.changedTouches)t.add(o.identifier)},u=i=>{for(let o of i.changedTouches)t.delete(o.identifier)};document.addEventListener("touchstart",n,!0),document.addEventListener("touchend",u,!0),document.addEventListener("touchcancel",u,!0),ul(EventTarget.prototype,"addEventListener",function(i,o){if(o!=="scrollend")return;let c=ad(()=>{t.size?c():this.dispatchEvent(new Event("scrollend"))},100);i.call(this,"scroll",c,{passive:!0}),s.set(this,c)}),ul(EventTarget.prototype,"removeEventListener",function(i,o){if(o!=="scrollend")return;let c=s.get(this);c&&i.call(this,"scroll",c,{passive:!0})})}})();var pl=J`
  :host {
    display: inline-block;
  }
...
`;var ld=0,qe=class extends Q{constructor(){super(...arguments),this.localize=new fe(this),this.attrId=++ld,this.componentId=`sl-tab-${this.attrId}`,this.panel="",this.active=!1,this.closable=!1,this.disabled=!1,this.tabIndex=0}connectedCallback(){super.connectedCallback(),this.setAttribute("role","tab")}handleCloseClick(e){e.stopPropagation(),this.emit("sl-close")}handleActiveChange(){this.setAttribute("aria-selected",this.active?"true":"false")}handleDisabledChange(){this.setAttribute("aria-disabled",this.disabled?"true":"false"),this.disabled&&!this.active?this.tabIndex=-1:this.tabIndex=0}render(){return this.id=this.id.length>0?this.id:this.componentId,F`
      <div
        part="base"
    ...
    `}};qe.styles=[oe,pl];qe.dependencies={"sl-icon-button":ve};T([Z(".tab")],qe.prototype,"tab",2);T([P({reflect:!0})],qe.prototype,"panel",2);T([P({type:Boolean,reflect:!0})],qe.prototype,"active",2);T([P({type:Boolean,reflect:!0})],qe.prototype,"closable",2);T([P({type:Boolean,reflect:!0})],qe.prototype,"disabled",2);T([P({type:Number,reflect:!0})],qe.prototype,"tabIndex",2);T([te("active")],qe.prototype,"handleActiveChange",1);T([te("disabled")],qe.prototype,"handleDisabledChange",1);qe.define("sl-tab");var fl=J`
  :host {
    --padding: 0;
...
`;var cd=0,pi=class extends Q{constructor(){super(...arguments),this.attrId=++cd,this.componentId=`sl-tab-panel-${this.attrId}`,this.name="",this.active=!1}connectedCallback(){super.connectedCallback(),this.id=this.id.length>0?this.id:this.componentId,this.setAttribute("role","tabpanel")}handleActiveChange(){this.setAttribute("aria-hidden",this.active?"false":"true")}render(){return F`
      <slot
        part="base"
        class=${re({"tab-panel":!0,"tab-panel--active":this.active})}
      ></slot>
    `}};pi.styles=[oe,fl];T([P({reflect:!0})],pi.prototype,"name",2);T([P({type:Boolean,reflect:!0})],pi.prototype,"active",2);T([te("active")],pi.prototype,"handleActiveChange",1);pi.define("sl-tab-panel");var _l=J`
  :host {
    display: inline-block;
  }
...
`;var Le=class extends Q{constructor(){super(...arguments),this.formControlController=new kt(this,{value:e=>e.checked?e.value||"on":void 0,defaultValue:e=>e.defaultChecked,setValue:(e,t)=>e.checked=t}),this.hasSlotController=new Ve(this,"help-text"),this.hasFocus=!1,this.title="",this.name="",this.size="medium",this.disabled=!1,this.checked=!1,this.defaultChecked=!1,this.form="",this.required=!1,this.helpText=""}get validity(){return this.input.validity}get validationMessage(){return this.input.validationMessage}firstUpdated(){this.formControlController.updateValidity()}handleBlur(){this.hasFocus=!1,this.emit("sl-blur")}handleInput(){this.emit("sl-input")}handleInvalid(e){this.formControlController.setValidity(!1),this.formControlController.emitInvalidEvent(e)}handleClick(){this.checked=!this.checked,this.emit("sl-change")}handleFocus(){this.hasFocus=!0,this.emit("sl-focus")}handleKeyDown(e){e.key==="ArrowLeft"&&(e.preventDefault(),this.checked=!1,this.emit("sl-change"),this.emit("sl-input")),e.key==="ArrowRight"&&(e.preventDefault(),this.checked=!0,this.emit("sl-change"),this.emit("sl-input"))}handleCheckedChange(){this.input.checked=this.checked,this.formControlController.updateValidity()}handleDisabledChange(){this.formControlController.setValidity(!0)}click(){this.input.click()}focus(e){this.input.focus(e)}blur(){this.input.blur()}checkValidity(){return this.input.checkValidity()}getForm(){return this.formControlController.getForm()}reportValidity(){return this.input.reportValidity()}setCustomValidity(e){this.input.setCustomValidity(e),this.formControlController.updateValidity()}render(){let e=this.hasSlotController.test("help-text"),t=this.helpText?!0:!!e;return F`
    ...
    `}};Le.styles=[oe,ai,_l];T([Z('input[type="checkbox"]')],Le.prototype,"input",2);T([pe()],Le.prototype,"hasFocus",2);T([P()],Le.prototype,"title",2);T([P()],Le.prototype,"name",2);T([P()],Le.prototype,"value",2);T([P({reflect:!0})],Le.prototype,"size",2);T([P({type:Boolean,reflect:!0})],Le.prototype,"disabled",2);T([P({type:Boolean,reflect:!0})],Le.prototype,"checked",2);T([Ws("checked")],Le.prototype,"defaultChecked",2);T([P({reflect:!0})],Le.prototype,"form",2);T([P({type:Boolean,reflect:!0})],Le.prototype,"required",2);T([P({attribute:"help-text"})],Le.prototype,"helpText",2);T([te("checked",{waitUntilFirstUpdate:!0})],Le.prototype,"handleCheckedChange",1);T([te("disabled",{waitUntilFirstUpdate:!0})],Le.prototype,"handleDisabledChange",1);Le.define("sl-switch");var ml=J`
  :host {
    display: contents;
...
`;var Fe=class Kt extends Q{constructor(){super(...arguments),this.hasSlotController=new Ve(this,"icon","suffix"),this.localize=new fe(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0,this.remainingTime=this.duration}static get toastStack(){return this.currentToastStack||(this.currentToastStack=Object.assign(document.createElement("div"),{className:"sl-toast-stack"})),this.currentToastStack}firstUpdated(){this.base.hidden=!this.open}restartAutoHide(){this.handleCountdownChange(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.duration),this.remainingTime=this.duration,this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100))}pauseAutoHide(){var t;(t=this.countdownAnimation)==null||t.pause(),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval)}resumeAutoHide(){var t;this.duration<1/0&&(this.autoHideTimeout=window.setTimeout(()=>this.hide(),this.remainingTime),this.remainingTimeInterval=window.setInterval(()=>{this.remainingTime-=100},100),(t=this.countdownAnimation)==null||t.play())}handleCountdownChange(){if(this.open&&this.duration<1/0&&this.countdown){let{countdownElement:t}=this,s="100%",n="0";this.countdownAnimation=t.animate([{width:s},{width:n}],{duration:this.duration,easing:"linear"})}}handleCloseClick(){this.hide()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.duration<1/0&&this.restartAutoHide(),await Ae(this.base),this.base.hidden=!1;let{keyframes:t,options:s}=Se(this,"alert.show",{dir:this.localize.dir()});await Ce(this.base,t,s),this.emit("sl-after-show")}else{Vs(this),this.emit("sl-hide"),clearTimeout(this.autoHideTimeout),clearInterval(this.remainingTimeInterval),await Ae(this.base);let{keyframes:t,options:s}=Se(this,"alert.hide",{dir:this.localize.dir()});await Ce(this.base,t,s),this.base.hidden=!0,this.emit("sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}async show(){if(!this.open)return this.open=!0,Oe(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,Oe(this,"sl-after-hide")}async toast(){return new Promise(t=>{this.handleCountdownChange(),Kt.toastStack.parentElement===null&&document.body.append(Kt.toastStack),Kt.toastStack.appendChild(this),requestAnimationFrame(()=>{this.clientWidth,this.show()}),this.addEventListener("sl-after-hide",()=>{Kt.toastStack.removeChild(this),t(),Kt.toastStack.querySelector("sl-alert")===null&&Kt.toastStack.remove()},{once:!0})})}render(){return F`
    ...
    `}};Fe.styles=[oe,ml];Fe.dependencies={"sl-icon-button":ve};T([Z('[part~="base"]')],Fe.prototype,"base",2);T([Z(".alert__countdown-elapsed")],Fe.prototype,"countdownElement",2);T([P({type:Boolean,reflect:!0})],Fe.prototype,"open",2);T([P({type:Boolean,reflect:!0})],Fe.prototype,"closable",2);T([P({reflect:!0})],Fe.prototype,"variant",2);T([P({type:Number})],Fe.prototype,"duration",2);T([P({type:String,reflect:!0})],Fe.prototype,"countdown",2);T([pe()],Fe.prototype,"remainingTime",2);T([te("open",{waitUntilFirstUpdate:!0})],Fe.prototype,"handleOpenChange",1);T([te("duration")],Fe.prototype,"handleDurationChange",1);var gl=Fe;we("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}});we("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});gl.define("sl-alert");var ye=Io(),me=zo(),le=or(location.hash),bl=me.getState(),vo=!0,ft="*",bo="",yo={},yl=null,nt=null,fi=null,ts={},qs=new Set;function hd(e,t){if(!(!e||!t)){ts[e]||(ts[e]={});for(let[s,n]of Object.entries(t)){if(n.status==="pending")continue;let u=`${e}:${s}`;ts[e][s]||qs.has(u)||(qs.add(u),me.send("get-agent-prompt",{runId:e,stage:s}).then(i=>{ts[e][s]=i,qs.delete(u),De()}).catch(()=>{qs.delete(u)}))}}}me.on("runs-list",e=>{let t={};for(let s of e.runs||[])t[s.id]=s;ye.setState({runs:t}),e.settings&&(yo=e.settings)});me.on("run-snapshot",e=>{e&&e.id&&(ye.setRun(e.id,e),nt&&(nt=null,De()))});me.on("run-update",e=>{e&&e.id&&(ye.setRun(e.id,e),nt&&(nt=null,De()))});me.on("log-line",e=>{e&&(ye.appendLog(e),e.iteration&&e.iteration>1&&e._iterStart&&Mn(e.iteration),Wr(e))});me.on("log-bulk",e=>{if(e&&Array.isArray(e.lines))for(let t of e.lines){let s={stage:e.stage,line:t};ye.appendLog(s),Wr(s)}});me.on("preferences",e=>{e&&(ye.setState({preferences:e}),xi(e.theme||"light"))});me.onConnection(e=>{bl=e,e==="open"&&(me.send("list-runs").then(t=>{let s={};for(let n of t.runs||[])s[n.id]=n;ye.setState({runs:s}),t.settings&&(yo=t.settings)}).catch(()=>{}),me.send("get-preferences").then(t=>{ye.setState({preferences:t}),xi(t.theme||"light")}).catch(()=>{}),le.runId&&(me.send("subscribe-run",{runId:le.runId}).catch(()=>{}),me.send("subscribe-log",{stage:ft==="*"?null:ft,runId:le.runId}).catch(()=>{}))),De()});No(e=>{let t=le.runId;le=e,t&&t!==le.runId&&(me.send("unsubscribe-run").catch(()=>{}),me.send("unsubscribe-log").catch(()=>{}),ye.clearLog(),Ii()),le.runId&&le.runId!==t&&(me.send("subscribe-run",{runId:le.runId}).catch(()=>{}),me.send("subscribe-log",{stage:null,runId:le.runId}).catch(()=>{})),le.section==="settings"&&Sr().then(()=>De()),!le.runId&&t&&Tn(),De()});function dd(e){gt(e,null)}function vl(e){gt(le.section,e)}function ud(){let t=ye.getState().preferences.theme==="dark"?"light":"dark";me.send("set-preferences",{theme:t}).catch(()=>{}),ye.setState({preferences:{theme:t}}),xi(t)}function pd(e){ft=e,yl=null,Ii(),ye.clearLog(),me.send("unsubscribe-log").catch(()=>{}),me.send("subscribe-log",{stage:e==="*"?null:e,runId:le.runId}).catch(()=>{}),De()}function fd(e){yl=e,Ii(),ye.clearLog(),me.send("unsubscribe-log").catch(()=>{}),me.send("subscribe-log",{stage:ft==="*"?null:ft,runId:le.runId,iteration:e}).catch(()=>{}),De()}function _d(e){bo=e,Rn(e)}function md(){vo=!vo,De()}function wl(e){fi=e,De(),requestAnimationFrame(()=>{let t=document.getElementById("action-error-dialog");t&&t.show()})}function gd(){fi=null,De()}function vd(){nt="stopping",fi=null,De(),me.send("stop-run").then(()=>{}).catch(e=>{nt=null,wl(e?.message||"Failed to stop pipeline")})}function bd(){nt="resuming",fi=null,De(),me.send("resume-run").then(()=>{}).catch(e=>{nt=null,wl(e?.message||"Failed to resume pipeline")})}function yd(){if(le.runId){let t=Object.values(ye.getState().runs).filter(s=>s.active);le.section==="active"&&t.length<=1?gt("dashboard",null):gt(le.section,null)}else le.section&&le.section!=="dashboard"&&gt("dashboard",null)}function wd(){let e=ye.getState(),t="Dashboard",s=!1,n=null,u=null;if(le.runId){let i=e.runs[le.runId],c=(i?.work_request?.title||"Pipeline Details").split(`
`)[0];if(t=c.length>80?c.slice(0,80)+"\u2026":c,s=!0,i){let p=i.runState||(i.active?"running":"terminal"),d=p==="running"?"warning":p==="interrupted"?"neutral":"success",f=p==="running"?"in_progress":p==="interrupted"?"interrupted":"completed",v=p==="running"?"Running":p==="interrupted"?"Interrupted":"Completed";n=F`<sl-badge variant="${d}" pill>
        ...
        ${v}
          ...
          <button class="action-btn action-btn--danger" @click=${vd}>
            ${X(Y(pr,14))}
            Stop Pipeline
          </button>`:p==="interrupted"&&(u=F`
          <button class="action-btn action-btn--primary" @click=${bd}>
            ${X(Y(fr,14))}
            Resume Pipeline
    ...
    <div class="content-header">
      ${s?F`
        <button class="content-header-back" @click=${yd}>
          ${X(Y(ur,18))}
        </button>
      `:""}
      ${n||""}
  ...
  `}function Sd(){let e=ye.getState(),t=Object.values(e.runs);if(le.runId){let s=e.runs[le.runId],n={};if(s?.stages){for(let[i,o]of Object.entries(s.stages)){let c=o.iterations||[];c.length>0&&(n[i]=c.length)}hd(le.runId,s.stages)}let u=Cd(e);return u.currentLogStage=ft==="*"?null:ft,F`
      ${Ko(s,yo,{promptCache:ts[le.runId]||{}})}
      ${Bn(u,{onStageFilter:pd,onIterationFilter:fd,onSearch:_d,onToggleAutoScroll:md,autoScroll:vo,stageIterations:n,runStages:s?.stages})}
    `}if(le.section==="settings")return Yo(e.preferences,{rerender:De,onThemeToggle:ud});if(le.section==="history")return wr(t,"history",{onSelectRun:vl});if(le.section==="active"){let s=t.filter(n=>n.active);return s.length===1?(gt("active",s[0].id),F``):wr(t,"active",{onSelectRun:vl})}return Go(e,{onSelectRun:s=>gt("active",s)})}function Cd(e){let t=e.logLines;if(ft!=="*"&&(t=t.filter(s=>s.stage===ft)),bo){let s=bo.toLowerCase();t=t.filter(n=>(n.line||"").toLowerCase().includes(s))}return{...e,logLines:t}}function De(){let e=ye.getState(),t=document.getElementById("app");t&&(cs(F`
    <div class="app-shell">
      ${Wo(e,le,bl,{onNavigate:dd})}
    ...
    ${fi?F`
      <sl-dialog id="action-error-dialog" label="Pipeline Error" @sl-after-hide=${gd}>
    ...
    `:""}
  `,t),le.runId&&On(le.runId))}ye.subscribe(()=>De());xi(ye.getState().preferences.theme);le.section==="settings"&&Sr().then(()=>De());De();
